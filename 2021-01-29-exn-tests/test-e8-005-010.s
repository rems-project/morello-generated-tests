...
.section data0, #alloc, #write
	.zero 704
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x17, 0x07, 0x00, 0x00
	.zero 3360
	.byte 0xcd, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
.data
check_data0:
	.byte 0x17, 0x07
.data
...
initial_cap_values:
	...
	/* C6 */
	.octa 0x80000000000100050000000040400384
	/* C15 */
	.octa 0x0
	/* C29 */
	.octa 0xc00000000003000400000000000012cc
el1_vector_jump_cap:
	.dword 0x40400300
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b2e4 // cvtp c4, x23
	.inst 0xc2d74084 // scvalue c4, c4, x23
	.inst 0x82600c97 // ldr x23, [c4, #0]
	cbnz x23, #28
	mrs x23, ESR_EL1
	.inst 0x82400c97 // str x23, [c4, #0]
	ldr x23, =0x40400028
	mrs x4, ELR_EL1
	sub x23, x23, x4
	cbnz x23, #8
