...
test_start:
	...
	.inst 0xb0c63993 // ADRP-C.IP-C Rd:19 immhi:100011000111001100 P:1 10000:10000 immlo:01 op:1
	.inst 0xd4000001
	.zero 56300
.text
.global preamble
...
finish:
	...
	.inst 0xc24003cf // ldr c15, [x30, #0]
	.inst 0xc2cfa401 // chkeq c0, c15
	b.ne comparison_fail
	.inst 0xc24007cf // ldr c15, [x30, #1]
	.inst 0xc2cfa421 // chkeq c1, c15
	b.ne comparison_fail
	.inst 0xc2400bcf // ldr c15, [x30, #2]
	.inst 0xc2cfa461 // chkeq c3, c15
	b.ne comparison_fail
	.inst 0xc2400fcf // ldr c15, [x30, #3]
	.inst 0xc2cfa4e1 // chkeq c7, c15
	b.ne comparison_fail
	.inst 0xc24013cf // ldr c15, [x30, #4]
	.inst 0xc2cfa521 // chkeq c9, c15
	b.ne comparison_fail
	.inst 0xc24017cf // ldr c15, [x30, #5]
	.inst 0xc2cfa581 // chkeq c12, c15
	b.ne comparison_fail
	.inst 0xc2401bcf // ldr c15, [x30, #6]
	.inst 0xc2cfa641 // chkeq c18, c15
	b.ne comparison_fail
	.inst 0xc2401fcf // ldr c15, [x30, #7]
	.inst 0xc2cfa661 // chkeq c19, c15
	b.ne comparison_fail
	.inst 0xc24023cf // ldr c15, [x30, #8]
	.inst 0xc2cfa741 // chkeq c26, c15
	b.ne comparison_fail
	.inst 0xc24027cf // ldr c15, [x30, #9]
...
final_cap_values:
	...
	.octa 0xfd8
	/* C19 */
	.octa 0xffffffffccb33000
	/* C26 */
	.octa 0x0
	/* C29 */
	.octa 0x1450
initial_DDC_EL0_value:
	.octa 0xc00000000022000600c0000000000001
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b3cf // cvtp c15, x30
	.inst 0xc2de41ef // scvalue c15, c15, x30
	.inst 0x82600dfe // ldr x30, [c15, #0]
	cbnz x30, #28
	mrs x30, ESR_EL1
	.inst 0x82400dfe // str x30, [c15, #0]
	ldr x30, =0x40402414
	mrs x15, ELR_EL1
	sub x30, x30, x15
	cbnz x30, #8
