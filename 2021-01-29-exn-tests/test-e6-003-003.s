...
tag_init_end:
	...
	msr cptr_el3, x7
	isb
	ldr q15, =0x40802001000000000000010010000
...
.data
check_data0:
	.byte 0x00, 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x02, 0x08, 0x04, 0x00
.data
check_data1:
	.zero 16
.data
...
initial_cap_values:
	...
	.octa 0xf69
	/* C6 */
	.octa 0xcc1000005a0410120000000000001400
	/* C8 */
	.octa 0x40400002
	/* C20 */
...
initial_SP_EL0_value:
	.octa 0x800000000080010800030440
initial_SP_EL1_value:
	.octa 0x3fff800000000000000000000000
initial_DDC_EL1_value:
	.octa 0xd0100000000100070080000000000001
initial_VBAR_EL1_value:
	.octa 0x20008000500000180000000040400000
final_SP_EL0_value:
	.octa 0x800000000080010800030440
final_SP_EL1_value:
	.octa 0x3fff800000000000000000000000
final_PCC_value:
	.octa 0x20008000500000180000000040400414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000001140050000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
