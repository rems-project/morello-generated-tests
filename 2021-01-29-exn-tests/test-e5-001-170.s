...
finish:
	...
	.inst 0xc24000bc // ldr c28, [x5, #0]
	.inst 0xc2dca401 // chkeq c0, c28
	b.ne comparison_fail
	.inst 0xc24004bc // ldr c28, [x5, #1]
	.inst 0xc2dca421 // chkeq c1, c28
	b.ne comparison_fail
	.inst 0xc24008bc // ldr c28, [x5, #2]
	...
	b.ne comparison_fail
	.inst 0xc24020bc // ldr c28, [x5, #8]
	.inst 0xc2dca5a1 // chkeq c13, c28
	b.ne comparison_fail
	.inst 0xc24024bc // ldr c28, [x5, #9]
	.inst 0xc2dca5c1 // chkeq c14, c28
	b.ne comparison_fail
	.inst 0xc24028bc // ldr c28, [x5, #10]
	.inst 0xc2dca621 // chkeq c17, c28
	b.ne comparison_fail
	.inst 0xc2402cbc // ldr c28, [x5, #11]
	.inst 0xc2dca681 // chkeq c20, c28
	b.ne comparison_fail
	.inst 0xc24030bc // ldr c28, [x5, #12]
	.inst 0xc2dca6c1 // chkeq c22, c28
	b.ne comparison_fail
	.inst 0xc24034bc // ldr c28, [x5, #13]
	.inst 0xc2dca721 // chkeq c25, c28
	b.ne comparison_fail
	.inst 0xc24038bc // ldr c28, [x5, #14]
	.inst 0xc2dca7a1 // chkeq c29, c28
	b.ne comparison_fail
	.inst 0xc2403cbc // ldr c28, [x5, #15]
...
.section data0, #alloc, #write
	...
	.zero 3536
	.byte 0x40, 0x04, 0x00, 0x40, 0x10, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 272
.data
check_data0:
	.byte 0x50, 0x20
...
initial_cap_values:
	...
	.octa 0x0
	/* C17 */
	.octa 0xc0000000508000020000000000001000
	/* C20 */
	.octa 0x4000000000000000000000000000
	/* C29 */
	.octa 0xc00000000000c0000000000000001ee0
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x80000000000738060000000040400001
initial_DDC_EL1_value:
	.octa 0xc00000003ffb00070000000000000021
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b0bc // cvtp c28, x5
	.inst 0xc2c5439c // scvalue c28, c28, x5
	.inst 0x82600f85 // ldr x5, [c28, #0]
	cbnz x5, #28
	mrs x5, ESR_EL1
	.inst 0x82400f85 // str x5, [c28, #0]
	ldr x5, =0x40400414
	mrs x28, ELR_EL1
	sub x5, x5, x28
	cbnz x5, #8
