...
.data
check_data0:
	.byte 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
.data
check_data1:
	.zero 2
.data
...
initial_cap_values:
	/* C0 */
	.octa 0x2000000000000006
	/* C1 */
	.octa 0xe000000040407ffa
	/* C4 */
	.octa 0x0
	/* C9 */
	.octa 0x3fff800000000000000000000000
	/* C24 */
	.octa 0x604420440000000000000001
	/* C28 */
	.octa 0x40000000600000020000000000001600
	/* C29 */
	.octa 0x0
	/* C30 */
...
final_cap_values:
	...
	.octa 0x40000000600000020000000000001600
	/* C29 */
	.octa 0xffffffffffffdfbc
	/* C30 */
	.octa 0x10000000000000000
initial_SP_EL1_value:
	.octa 0x1e00
initial_DDC_EL0_value:
	.octa 0x80000000400480000000000040408001
initial_DDC_EL1_value:
	.octa 0x4c0000000127000300fffffffffefef9
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b1d0 // cvtp c16, x14
	.inst 0xc2ce4210 // scvalue c16, c16, x14
	.inst 0x82600e0e // ldr x14, [c16, #0]
	cbnz x14, #28
	mrs x14, ESR_EL1
	.inst 0x82400e0e // str x14, [c16, #0]
	ldr x14, =0x40400414
	mrs x16, ELR_EL1
	sub x14, x14, x16
	cbnz x14, #8
