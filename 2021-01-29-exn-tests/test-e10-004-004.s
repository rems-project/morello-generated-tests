...
finish:
	...
	.inst 0xc240028d // ldr c13, [x20, #0]
	.inst 0xc2cda401 // chkeq c0, c13
	b.ne comparison_fail
	.inst 0xc240068d // ldr c13, [x20, #1]
	...
	b.ne comparison_fail
	.inst 0xc2401e8d // ldr c13, [x20, #7]
	.inst 0xc2cda5e1 // chkeq c15, c13
	b.ne comparison_fail
	.inst 0xc240228d // ldr c13, [x20, #8]
	.inst 0xc2cda6e1 // chkeq c23, c13
	b.ne comparison_fail
	.inst 0xc240268d // ldr c13, [x20, #9]
	.inst 0xc2cda761 // chkeq c27, c13
	b.ne comparison_fail
	.inst 0xc2402a8d // ldr c13, [x20, #10]
	.inst 0xc2cda7a1 // chkeq c29, c13
	b.ne comparison_fail
	.inst 0xc2402e8d // ldr c13, [x20, #11]
...
initial_VBAR_EL1_value:
	.octa 0x200080005000000f0000000040400000
final_PCC_value:
	.octa 0x200080005000000f0000000040400028
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b28d // cvtp c13, x20
	.inst 0xc2d441ad // scvalue c13, c13, x20
	.inst 0x82600db4 // ldr x20, [c13, #0]
	cbnz x20, #28
	mrs x20, ESR_EL1
	.inst 0x82400db4 // str x20, [c13, #0]
	ldr x20, =0x40400028
	mrs x13, ELR_EL1
	sub x20, x20, x13
	cbnz x20, #8
