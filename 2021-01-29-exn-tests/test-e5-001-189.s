...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24030d3 // ldr c19, [x6, #12]
	.inst 0xc2d3a6c1 // chkeq c22, c19
	b.ne comparison_fail
	.inst 0xc24034d3 // ldr c19, [x6, #13]
	.inst 0xc2d3a721 // chkeq c25, c19
	b.ne comparison_fail
	.inst 0xc24038d3 // ldr c19, [x6, #14]
	.inst 0xc2d3a7a1 // chkeq c29, c19
	b.ne comparison_fail
	.inst 0xc2403cd3 // ldr c19, [x6, #15]
...
.section data0, #alloc, #write
	...
	.zero 3808
	.byte 0xe2, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 256
.data
check_data0:
	.byte 0x00, 0x00, 0x00, 0x08, 0x02, 0x02, 0x10, 0x00
.data
check_data1:
	.zero 2
.data
...
initial_cap_values:
	...
	/* C14 */
	.octa 0x40000000000a400efefffffffffffff0
	/* C17 */
	.octa 0xc00000006001040c0000000000001004
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000600409120000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x800000000007000700000000403fe003
initial_DDC_EL1_value:
	.octa 0xc0000000000100050000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080006000f41d0000000040400000
final_SP_EL1_value:
	.octa 0x3fff800000000000000000000000
final_PCC_value:
	.octa 0x200080006000f41d0000000040400414
