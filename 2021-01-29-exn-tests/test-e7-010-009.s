...
check_data3:
	...
	.byte 0xc0, 0xa2, 0x34, 0x39, 0x37, 0x54, 0xbf, 0x9b, 0x5c, 0x22, 0x7f, 0xf0, 0x1e, 0x94, 0x1d, 0x79
	.byte 0x60, 0x85, 0xca, 0xc2
.data
check_data4:
...
initial_cap_values:
	...
	/* C10 */
	.octa 0x400020000000000000000000000000
	/* C11 */
	.octa 0x20408020402a80020000000040408020
	/* C22 */
	.octa 0x40000000400400080000000000000ad0
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x40000000400400080000000000000ad0
	/* C28 */
	.octa 0x400000001007100701000000fe449000
	/* C29 */
...
initial_DDC_EL0_value:
	.octa 0x400000001007100700ffffffffffe000
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_SP_EL0_value:
	.octa 0xc0
final_PCC_value:
	.octa 0x20408000402a80020000000040408024
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b283 // cvtp c3, x20
	.inst 0xc2d44063 // scvalue c3, c3, x20
	.inst 0x82600c74 // ldr x20, [c3, #0]
	cbnz x20, #28
	mrs x20, ESR_EL1
	.inst 0x82400c74 // str x20, [c3, #0]
	ldr x20, =0x40408024
	mrs x3, ELR_EL1
	sub x20, x20, x3
	cbnz x20, #8
