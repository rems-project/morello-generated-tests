...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24036fc // ldr c28, [x23, #13]
	.inst 0xc2dca721 // chkeq c25, c28
	b.ne comparison_fail
	.inst 0xc2403afc // ldr c28, [x23, #14]
	.inst 0xc2dca7a1 // chkeq c29, c28
	b.ne comparison_fail
	.inst 0xc2403efc // ldr c28, [x23, #15]
...
.section data0, #alloc, #write
	.byte 0x38, 0x08, 0x00, 0x00, 0x30, 0x10, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
	.byte 0x00, 0x10, 0x00, 0x04, 0x00, 0x00, 0x00, 0x00
.data
check_data1:
	.zero 1
.data
...
initial_cap_values:
	...
	/* C14 */
	.octa 0x48000000420102070040220000000208
	/* C17 */
	.octa 0xc0000000400100050000000000001000
	/* C20 */
	.octa 0x0
	/* C29 */
...
initial_DDC_EL0_value:
	.octa 0x800000005c01089600000000403fe001
initial_DDC_EL1_value:
	.octa 0xc0000000000100050000000000000001
initial_VBAR_EL1_value:
	.octa 0x20008000600000410000000040400000
final_SP_EL1_value:
	.octa 0x3fff800000000000000000000000
final_PCC_value:
	.octa 0x20008000600000410000000040400414
