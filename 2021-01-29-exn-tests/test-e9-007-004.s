...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402043 // ldr c3, [x2, #8]
	.inst 0xc2c3a681 // chkeq c20, c3
	b.ne comparison_fail
	.inst 0xc2402443 // ldr c3, [x2, #9]
	.inst 0xc2c3a761 // chkeq c27, c3
	b.ne comparison_fail
	.inst 0xc2402843 // ldr c3, [x2, #10]
	.inst 0xc2c3a781 // chkeq c28, c3
	b.ne comparison_fail
	.inst 0xc2402c43 // ldr c3, [x2, #11]
	.inst 0xc2c3a7a1 // chkeq c29, c3
	b.ne comparison_fail
	.inst 0xc2403043 // ldr c3, [x2, #12]
...
.section data0, #alloc, #write
	.zero 2560
	.byte 0x62, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 1520
.data
check_data0:
	.zero 4
...
.data
check_data4:
	.byte 0x62, 0x30, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80
.data
check_data5:
	.byte 0x01, 0x20
.data
...
initial_cap_values:
	...
	.octa 0x1000
	/* C29 */
	.octa 0x8000000052010a0c0000000000001032
	/* C30 */
	.octa 0x1810
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_SP_EL0_value:
	.octa 0x800000001077400e0000000040408800
initial_DDC_EL0_value:
	.octa 0xcc0000003ffb000700ffe00000000001
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_SP_EL0_value:
	.octa 0x800000001077400e0000000040408800
final_PCC_value:
	.octa 0x20008000600100000000000040400028
