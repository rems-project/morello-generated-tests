...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402f49 // ldr c9, [x26, #11]
	.inst 0xc2c9a681 // chkeq c20, c9
	b.ne comparison_fail
	.inst 0xc2403349 // ldr c9, [x26, #12]
	.inst 0xc2c9a6c1 // chkeq c22, c9
	b.ne comparison_fail
	.inst 0xc2403749 // ldr c9, [x26, #13]
	.inst 0xc2c9a721 // chkeq c25, c9
	b.ne comparison_fail
	.inst 0xc2403b49 // ldr c9, [x26, #14]
	.inst 0xc2c9a7a1 // chkeq c29, c9
	b.ne comparison_fail
	.inst 0xc2403f49 // ldr c9, [x26, #15]
...
.section data0, #alloc, #write
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
	.byte 0x04, 0x00, 0x00, 0x00, 0x08, 0x00, 0x80, 0x00
.data
check_data1:
	.zero 1
.data
...
.data
check_data5:
	.byte 0x00, 0x13, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
initial_cap_values:
	...
	.octa 0x1000
	/* C12 */
	.octa 0xc00000005001000f0000000000001000
	/* C13 */
	.octa 0x3fff800000000000000000000000
	/* C14 */
	.octa 0x40000000400400020080000000000001
	/* C17 */
	.octa 0xc00000003a4100070000000000001000
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000310300030000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x800000000000a0080000000000000001
initial_DDC_EL1_value:
	.octa 0xc00000000003000100f8000000000001
initial_VBAR_EL1_value:
	.octa 0x200080004440009d0000000040400000
final_SP_EL1_value:
	.octa 0x3fff800000000000000000000000
final_PCC_value:
	.octa 0x200080004440009d0000000040400414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x2000800008f300070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
