...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2403b92 // ldr c18, [x28, #14]
	.inst 0xc2d2a7a1 // chkeq c29, c18
	b.ne comparison_fail
	.inst 0xc2403f92 // ldr c18, [x28, #15]
...
.section data0, #alloc, #write
	.zero 3792
	.byte 0x08, 0x00, 0x00, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 288
.data
check_data0:
	.zero 2
...
initial_cap_values:
	...
	/* C14 */
	.octa 0x4c000000501480020000000000009000
	/* C17 */
	.octa 0xc0000000000100050000000000001040
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000400107f40000000000001ed0
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x80000000700001100000000040400001
initial_DDC_EL1_value:
	.octa 0xc0000000088000000080040100667000
initial_VBAR_EL1_value:
	.octa 0x200080005800dc1d0000000040400000
final_SP_EL1_value:
	.octa 0x3fff800000000000000000000000
final_PCC_value:
	.octa 0x200080005800dc1d0000000040400414
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b392 // cvtp c18, x28
	.inst 0xc2dc4252 // scvalue c18, c18, x28
	.inst 0x82600e5c // ldr x28, [c18, #0]
	cbnz x28, #28
	mrs x28, ESR_EL1
	.inst 0x82400e5c // str x28, [c18, #0]
	ldr x28, =0x40400414
	mrs x18, ELR_EL1
	sub x28, x28, x18
	cbnz x28, #8
