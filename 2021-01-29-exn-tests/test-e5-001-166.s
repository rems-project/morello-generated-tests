...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402d66 // ldr c6, [x11, #11]
	.inst 0xc2c6a681 // chkeq c20, c6
	b.ne comparison_fail
	.inst 0xc2403166 // ldr c6, [x11, #12]
	.inst 0xc2c6a6c1 // chkeq c22, c6
	b.ne comparison_fail
	.inst 0xc2403566 // ldr c6, [x11, #13]
	.inst 0xc2c6a721 // chkeq c25, c6
	b.ne comparison_fail
	.inst 0xc2403966 // ldr c6, [x11, #14]
	.inst 0xc2c6a7a1 // chkeq c29, c6
	b.ne comparison_fail
	.inst 0xc2403d66 // ldr c6, [x11, #15]
...
.section data0, #alloc, #write
	...
	.zero 944
	.byte 0x00, 0x00, 0x00, 0x00, 0x70, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 3056
.data
check_data0:
	.byte 0x70, 0x13
...
.data
check_data3:
	.byte 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04
.data
check_data4:
	.zero 1
.data
...
initial_cap_values:
	...
	.octa 0x1040
	/* C12 */
	.octa 0xc0000000500100240000000000001000
	/* C13 */
	.octa 0x0
	/* C14 */
	.octa 0x480000002801240f28ffffffffffffff
	/* C17 */
	.octa 0xc0000000400000210000000000001000
	/* C20 */
	.octa 0x4000000000000000000000000000
	/* C29 */
	.octa 0xc0000000400006410000000000001400
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x80000000200200070000000040404003
initial_DDC_EL1_value:
	.octa 0xc000000022010005000000000000a001
initial_VBAR_EL1_value:
	.octa 0x200080005800001d0000000040401000
final_SP_EL1_value:
	.octa 0x0
final_PCC_value:
	.octa 0x200080005800001d0000000040401414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000200500840000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
