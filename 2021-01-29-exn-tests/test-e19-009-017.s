...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24028c4 // ldr c4, [x6, #10]
	.inst 0xc2c4a781 // chkeq c28, c4
	b.ne comparison_fail
	.inst 0xc2402cc4 // ldr c4, [x6, #11]
	.inst 0xc2c4a7a1 // chkeq c29, c4
	b.ne comparison_fail
	.inst 0xc24030c4 // ldr c4, [x6, #12]
...
initial_cap_values:
	...
	.octa 0xfcf
	/* C7 */
	.octa 0x80000000500400800000000040401010
	/* C13 */
	.octa 0x4800000004028003ff80000020002011
	/* C15 */
	.octa 0x0
	/* C17 */
...
final_cap_values:
	...
	.octa 0xfcf
	/* C7 */
	.octa 0x80000000500400800000000040400e50
	/* C13 */
	.octa 0x4800000004028003ff80000020002011
	/* C15 */
	.octa 0x0
...
initial_SP_EL0_value:
	.octa 0x40000000001700fb0000000000002090
