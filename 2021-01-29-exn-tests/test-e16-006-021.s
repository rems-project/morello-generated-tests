...
finish:
	...
	.inst 0xc24003c7 // ldr c7, [x30, #0]
	.inst 0xc2c7a401 // chkeq c0, c7
	b.ne comparison_fail
	.inst 0xc24007c7 // ldr c7, [x30, #1]
	.inst 0xc2c7a421 // chkeq c1, c7
	b.ne comparison_fail
	.inst 0xc2400bc7 // ldr c7, [x30, #2]
	.inst 0xc2c7a441 // chkeq c2, c7
	b.ne comparison_fail
	.inst 0xc2400fc7 // ldr c7, [x30, #3]
	.inst 0xc2c7a4c1 // chkeq c6, c7
	b.ne comparison_fail
	.inst 0xc24013c7 // ldr c7, [x30, #4]
	.inst 0xc2c7a581 // chkeq c12, c7
	b.ne comparison_fail
	.inst 0xc24017c7 // ldr c7, [x30, #5]
	.inst 0xc2c7a661 // chkeq c19, c7
	b.ne comparison_fail
	.inst 0xc2401bc7 // ldr c7, [x30, #6]
...
initial_cap_values:
	/* C0 */
	.octa 0x4440000000000000
	/* C1 */
	.octa 0x80000000400400810000000000001000
	/* C2 */
	.octa 0x1000
	/* C19 */
	.octa 0x400000000007000f0000000000001000
	/* C29 */
	.octa 0x80000000400105850000000000001580
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x0
	/* C19 */
	.octa 0x400000000007000f000000000000106f
	/* C29 */
	.octa 0x0
initial_SP_EL0_value:
	.octa 0xc0000000505200040000000000001000
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x20008000000610070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b3c7 // cvtp c7, x30
	.inst 0xc2de40e7 // scvalue c7, c7, x30
	.inst 0x82600cfe // ldr x30, [c7, #0]
	cbnz x30, #28
	mrs x30, ESR_EL1
	.inst 0x82400cfe // str x30, [c7, #0]
	ldr x30, =0x40400414
	mrs x7, ELR_EL1
	sub x30, x30, x7
	cbnz x30, #8
