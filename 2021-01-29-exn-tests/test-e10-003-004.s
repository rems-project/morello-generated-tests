...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402857 // ldr c23, [x2, #10]
	.inst 0xc2d7a761 // chkeq c27, c23
	b.ne comparison_fail
	.inst 0xc2402c57 // ldr c23, [x2, #11]
	.inst 0xc2d7a7a1 // chkeq c29, c23
	b.ne comparison_fail
	.inst 0xc2403057 // ldr c23, [x2, #12]
...
initial_cap_values:
	...
	/* C29 */
	.octa 0x4c0000004004000a0000000000001020
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_SP_EL0_value:
	.octa 0x80000000000700240000000000001820
initial_DDC_EL0_value:
	.octa 0xc00000000006000700ffffffffe00003
initial_DDC_EL1_value:
	.octa 0x80000000400202200000000000000002
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x20008000003f00070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
