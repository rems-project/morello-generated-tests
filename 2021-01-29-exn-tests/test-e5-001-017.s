...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2403138 // ldr c24, [x9, #12]
	.inst 0xc2d8a6c1 // chkeq c22, c24
	b.ne comparison_fail
	.inst 0xc2403538 // ldr c24, [x9, #13]
	.inst 0xc2d8a721 // chkeq c25, c24
	b.ne comparison_fail
	.inst 0xc2403938 // ldr c24, [x9, #14]
	.inst 0xc2d8a7a1 // chkeq c29, c24
	b.ne comparison_fail
	.inst 0xc2403d38 // ldr c24, [x9, #15]
...
.section data0, #alloc, #write
	.byte 0x40, 0x21, 0x00, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
...
initial_cap_values:
	...
	.octa 0x0
	/* C14 */
	.octa 0x4c0000004024c038007fffffffffffff
	/* C17 */
	.octa 0xc0000000520000020000000000001000
	/* C20 */
	.octa 0x0
	/* C29 */
...
initial_DDC_EL1_value:
	.octa 0xc00000005f22100000ffffffffffe001
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x200080001087c0020000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
