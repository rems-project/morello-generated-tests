...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402aa5 // ldr c5, [x21, #10]
	.inst 0xc2c5a7a1 // chkeq c29, c5
	b.ne comparison_fail
	.inst 0xc2402ea5 // ldr c5, [x21, #11]
...
.section data0, #alloc, #write
	.zero 96
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x9a, 0x00, 0x00, 0x00
	.zero 3984
.data
check_data0:
	.byte 0x88, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x02, 0x20, 0x40, 0x00, 0x04
.data
check_data1:
	.zero 16
.data
...
.data
check_data4:
	.byte 0x00, 0xf0, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff
.data
check_data5:
	.zero 2
.data
check_data6:
	...
	.byte 0x3f, 0x48, 0x7c, 0xa9, 0x1f, 0xbe, 0x4a, 0xe2, 0x14, 0x50, 0x98, 0x02, 0xa8, 0x83, 0xb7, 0xb8
	.byte 0x61, 0x02, 0x08, 0xc2, 0x01, 0x00, 0x00, 0xd4

.data
.balign 16
initial_cap_values:
	/* C0 */
	.octa 0xc00080000000000000006000
	/* C1 */
	.octa 0x4004020020040000000000000001088
	/* C2 */
	.octa 0xffffffffffffa000
	/* C7 */
	.octa 0x0
	/* C16 */
	.octa 0x8000000050c108d40000000000001001
	/* C19 */
...
final_cap_values:
	...
	.octa 0xfffffffffffff000
	/* C20 */
	.octa 0xc000800000000000000059ec
	/* C23 */
	.octa 0x0
	/* C29 */
	.octa 0x106c
...
initial_DDC_EL0_value:
	.octa 0xc80000002007000f00ffffffffffe000
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_SP_EL0_value:
	.octa 0x2020
final_PCC_value:
	.octa 0x20008000000180060000000040400028
