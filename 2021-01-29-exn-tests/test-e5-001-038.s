...
.section data0, #alloc, #write
	.byte 0x00, 0x00, 0x00, 0x04, 0x00, 0x08, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
...
initial_cap_values:
	...
	.octa 0x0
	/* C14 */
	.octa 0x4c0000004104c108007ffffffffffff0
	/* C17 */
	.octa 0xc00000000006000f0000000000001000
	/* C20 */
	.octa 0x4000000000000000000000000000
	/* C29 */
	.octa 0xc0000000200900050000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_VBAR_EL1_value:
	.octa 0x20008000400000120000000040400000
final_SP_EL1_value:
	.octa 0x0
final_PCC_value:
	.octa 0x20008000400000120000000040400414
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b2bc // cvtp c28, x21
	.inst 0xc2d5439c // scvalue c28, c28, x21
	.inst 0x82600f95 // ldr x21, [c28, #0]
	cbnz x21, #28
	mrs x21, ESR_EL1
	.inst 0x82400f95 // str x21, [c28, #0]
	ldr x21, =0x40400414
	mrs x28, ELR_EL1
	sub x21, x21, x28
	cbnz x21, #8
