...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402af0 // ldr c16, [x23, #10]
	.inst 0xc2d0a621 // chkeq c17, c16
	b.ne comparison_fail
	.inst 0xc2402ef0 // ldr c16, [x23, #11]
	.inst 0xc2d0a681 // chkeq c20, c16
	b.ne comparison_fail
	.inst 0xc24032f0 // ldr c16, [x23, #12]
	.inst 0xc2d0a6c1 // chkeq c22, c16
	b.ne comparison_fail
	.inst 0xc24036f0 // ldr c16, [x23, #13]
	.inst 0xc2d0a721 // chkeq c25, c16
	b.ne comparison_fail
	.inst 0xc2403af0 // ldr c16, [x23, #14]
	.inst 0xc2d0a7a1 // chkeq c29, c16
	b.ne comparison_fail
	.inst 0xc2403ef0 // ldr c16, [x23, #15]
...
.section data0, #alloc, #write
	.byte 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x41, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
...
initial_cap_values:
	...
	.octa 0x0
	/* C29 */
	.octa 0xc0000000200200010000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x80000000008701430000000040460001
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x200080000007e0070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
