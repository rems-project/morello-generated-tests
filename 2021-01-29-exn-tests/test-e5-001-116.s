...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2403670 // ldr c16, [x19, #13]
	.inst 0xc2d0a721 // chkeq c25, c16
	b.ne comparison_fail
	.inst 0xc2403a70 // ldr c16, [x19, #14]
	.inst 0xc2d0a7a1 // chkeq c29, c16
	b.ne comparison_fail
	.inst 0xc2403e70 // ldr c16, [x19, #15]
...
.data
check_data0:
	.byte 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00
.data
check_data1:
	.zero 1
.data
...
initial_cap_values:
	...
	.octa 0x0
	/* C14 */
	.octa 0x4800000000068007ff80000000800001
	/* C17 */
	.octa 0xc0000000400004090000000000001400
	/* C20 */
	.octa 0x0
	/* C29 */
...
initial_VBAR_EL1_value:
	.octa 0x20008000500000210000000040400000
final_SP_EL1_value:
	.octa 0x0
final_PCC_value:
	.octa 0x20008000500000210000000040400414
