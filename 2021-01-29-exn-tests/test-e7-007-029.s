...
.section data0, #alloc, #write
	.zero 16
	.byte 0x00, 0x80, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x80, 0x00, 0x00, 0x80, 0x00, 0x20
...
initial_cap_values:
	...
	.octa 0x8
	/* C7 */
	.octa 0x90100000000300070000000000001000
	/* C17 */
	.octa 0x0
	/* C20 */
	.octa 0x0
...
final_cap_values:
	...
	.octa 0x0
	/* C30 */
	.octa 0x200080009007900b0000000040400014
initial_DDC_EL0_value:
	.octa 0xd0000000580110280000000000000000
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_PCC_value:
	.octa 0x20008000008000100000000040408014
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x200080001007900b0000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b0b0 // cvtp c16, x5
	.inst 0xc2c54210 // scvalue c16, c16, x5
	.inst 0x82600e05 // ldr x5, [c16, #0]
	cbnz x5, #28
	mrs x5, ESR_EL1
	.inst 0x82400e05 // str x5, [c16, #0]
	ldr x5, =0x40408014
	mrs x16, ELR_EL1
	sub x5, x5, x16
	cbnz x5, #8
