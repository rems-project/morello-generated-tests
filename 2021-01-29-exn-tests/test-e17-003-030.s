...
initial_cap_values:
	/* C1 */
	.octa 0xdc100000400000010000000000001000
	/* C4 */
	.octa 0xc00000000041c005000000000000100c
	/* C10 */
	.octa 0x20008000000100070000000040400401
	/* C11 */
	.octa 0xffffffffffffffffffffffffffffffff
	/* C13 */
	.octa 0x8000000000010005000000001e5d9ffc
	/* C16 */
	.octa 0xdc1000004002100200000000000017e0
	/* C17 */
	.octa 0x31000000000000000000000000
	/* C29 */
	.octa 0x800000002001c00500000000404040c4
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x0
	/* C29 */
	.octa 0x20008000000100070000000010f1b000
	/* C30 */
	.octa 0x2000800000064007000000004040000d
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_PCC_value:
	.octa 0x2000800000010007000000004040041c
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b325 // cvtp c5, x25
	.inst 0xc2d940a5 // scvalue c5, c5, x25
	.inst 0x82600cb9 // ldr x25, [c5, #0]
	cbnz x25, #28
	mrs x25, ESR_EL1
	.inst 0x82400cb9 // str x25, [c5, #0]
	ldr x25, =0x4040041c
	mrs x5, ELR_EL1
	sub x25, x25, x5
	cbnz x25, #8
