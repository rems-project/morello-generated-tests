...
initial_cap_values:
	...
	.octa 0x1000
	/* C4 */
	.octa 0x80000000450884d499c80080403086cd
	/* C9 */
	.octa 0x3fff800000000000000000000000
	/* C24 */
	.octa 0x40010004000007ff00000001
	/* C28 */
	.octa 0x40000000400201090000000000001802
	/* C29 */
	.octa 0x0
	/* C30 */
...
final_cap_values:
	...
	.octa 0x40000000400201090000000000001802
	/* C29 */
	.octa 0xfffff800fffffffc
	/* C30 */
	.octa 0x70000000000000000
initial_SP_EL1_value:
	.octa 0x48000000504000010000000000001e00
initial_DDC_EL0_value:
	.octa 0x800000000003000700ffe00000000001
initial_VBAR_EL1_value:
	.octa 0x200080004000001d0000000040400001
final_SP_EL1_value:
	.octa 0x48000000504000010000000000001000
final_PCC_value:
	.octa 0x200080004000001d0000000040400414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000032700070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b259 // cvtp c25, x18
	.inst 0xc2d24339 // scvalue c25, c25, x18
	.inst 0x82600f32 // ldr x18, [c25, #0]
	cbnz x18, #28
	mrs x18, ESR_EL1
	.inst 0x82400f32 // str x18, [c25, #0]
	ldr x18, =0x40400414
	mrs x25, ELR_EL1
	sub x18, x18, x25
	cbnz x18, #8
