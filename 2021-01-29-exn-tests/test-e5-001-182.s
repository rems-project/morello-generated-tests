...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402eab // ldr c11, [x21, #11]
	.inst 0xc2cba681 // chkeq c20, c11
	b.ne comparison_fail
	.inst 0xc24032ab // ldr c11, [x21, #12]
	.inst 0xc2cba6c1 // chkeq c22, c11
	b.ne comparison_fail
	.inst 0xc24036ab // ldr c11, [x21, #13]
	.inst 0xc2cba721 // chkeq c25, c11
	b.ne comparison_fail
	.inst 0xc2403aab // ldr c11, [x21, #14]
	.inst 0xc2cba7a1 // chkeq c29, c11
	b.ne comparison_fail
	.inst 0xc2403eab // ldr c11, [x21, #15]
...
.section data0, #alloc, #write
	...
	.zero 800
	.byte 0xf6, 0x41, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 3056
.data
check_data0:
	.byte 0x06, 0x10, 0x00, 0xc0, 0x00, 0x00, 0x01, 0x80
.data
check_data1:
	.byte 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
.data
...
initial_cap_values:
	...
	.octa 0x1000
	/* C12 */
	.octa 0xc0000000100300070000000000001000
	/* C13 */
	.octa 0x0
	/* C14 */
	.octa 0x800000000080000000000000
	/* C17 */
	.octa 0xc0000000000300070000000000001400
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000400400c40000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
