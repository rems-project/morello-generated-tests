...
.section data0, #alloc, #write
	.byte 0xf0, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x01, 0x01, 0x00, 0x00
	.zero 2032
...
initial_cap_values:
	/* C0 */
	.octa 0x80000000000100060000000000001f39
	/* C20 */
	.octa 0x0
	/* C24 */
	.octa 0x90000000000900050000000000001011
	/* C30 */
	.octa 0x1800
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x0
	/* C7 */
	.octa 0xfffffffffd12a800
	/* C10 */
	.octa 0x0
	/* C12 */
	.octa 0x101800000000000000000001ff0
	/* C17 */
	.octa 0x80000000000100060000000000001f39
	/* C20 */
	.octa 0x0
...
initial_DDC_EL0_value:
	.octa 0xc00000004001080200ffffffffffe001
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b066 // cvtp c6, x3
	.inst 0xc2c340c6 // scvalue c6, c6, x3
	.inst 0x82600cc3 // ldr x3, [c6, #0]
	cbnz x3, #28
	mrs x3, ESR_EL1
	.inst 0x82400cc3 // str x3, [c6, #0]
	ldr x3, =0x40400028
	mrs x6, ELR_EL1
	sub x3, x3, x6
	cbnz x3, #8
