...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2403a50 // ldr c16, [x18, #14]
	.inst 0xc2d0a7a1 // chkeq c29, c16
	b.ne comparison_fail
	.inst 0xc2403e50 // ldr c16, [x18, #15]
...
.section data0, #alloc, #write
	...
	.zero 1264
	.byte 0x30, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 752
...
initial_cap_values:
	...
	.octa 0x1000
	/* C12 */
	.octa 0xc00000000007000c0000000000001000
	/* C13 */
	.octa 0x3fff800000000000000000000000
	/* C14 */
	.octa 0x400000000003e541007ffffffffffff0
	/* C17 */
	.octa 0xc0000000000600070000000000001500
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000600208040000000000001800
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_VBAR_EL1_value:
	.octa 0x200080004000c819000000004040c800
final_SP_EL1_value:
	.octa 0x3fff800000000000000000000000
final_PCC_value:
	.octa 0x200080004000c819000000004040cc14
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000005300070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b250 // cvtp c16, x18
	.inst 0xc2d24210 // scvalue c16, c16, x18
	.inst 0x82600e12 // ldr x18, [c16, #0]
	cbnz x18, #28
	mrs x18, ESR_EL1
	.inst 0x82400e12 // str x18, [c16, #0]
	ldr x18, =0x4040cc14
	mrs x16, ELR_EL1
	sub x18, x18, x16
	cbnz x18, #8
