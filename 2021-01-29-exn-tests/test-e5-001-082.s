...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2403397 // ldr c23, [x28, #12]
	.inst 0xc2d7a6c1 // chkeq c22, c23
	b.ne comparison_fail
	.inst 0xc2403797 // ldr c23, [x28, #13]
	.inst 0xc2d7a721 // chkeq c25, c23
	b.ne comparison_fail
	.inst 0xc2403b97 // ldr c23, [x28, #14]
	.inst 0xc2d7a7a1 // chkeq c29, c23
	b.ne comparison_fail
	.inst 0xc2403f97 // ldr c23, [x28, #15]
...
.section data0, #alloc, #write
	...
	.zero 2032
	.byte 0x00, 0x00, 0x40, 0x20, 0x40, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 1792
	.byte 0x7c, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 224
.data
check_data0:
...
.data
check_data1:
	.byte 0xfc, 0x10, 0x00, 0x00, 0x80, 0x00, 0x00, 0x02
.data
check_data2:
	.zero 2
.data
...
initial_cap_values:
	...
	/* C17 */
	.octa 0xc000000040010d1c0000000000001800
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000400207c20000000000001800
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x800000001007000f00ffffffffffe003
