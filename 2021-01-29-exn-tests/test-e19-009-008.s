...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2400d02 // ldr c2, [x8, #3]
	.inst 0xc2c2a4e1 // chkeq c7, c2
	b.ne comparison_fail
	.inst 0xc2401102 // ldr c2, [x8, #4]
	.inst 0xc2c2a5a1 // chkeq c13, c2
	b.ne comparison_fail
	.inst 0xc2401502 // ldr c2, [x8, #5]
	.inst 0xc2c2a5e1 // chkeq c15, c2
	b.ne comparison_fail
	.inst 0xc2401902 // ldr c2, [x8, #6]
	.inst 0xc2c2a621 // chkeq c17, c2
	b.ne comparison_fail
	.inst 0xc2401d02 // ldr c2, [x8, #7]
	.inst 0xc2c2a641 // chkeq c18, c2
	b.ne comparison_fail
	.inst 0xc2402102 // ldr c2, [x8, #8]
	.inst 0xc2c2a6e1 // chkeq c23, c2
	b.ne comparison_fail
	.inst 0xc2402502 // ldr c2, [x8, #9]
	.inst 0xc2c2a721 // chkeq c25, c2
	b.ne comparison_fail
	.inst 0xc2402902 // ldr c2, [x8, #10]
	.inst 0xc2c2a781 // chkeq c28, c2
	b.ne comparison_fail
	.inst 0xc2402d02 // ldr c2, [x8, #11]
	.inst 0xc2c2a7a1 // chkeq c29, c2
	b.ne comparison_fail
	.inst 0xc2403102 // ldr c2, [x8, #12]
...
initial_cap_values:
	...
	.octa 0x0
	/* C5 */
	.octa 0x400000000800000800000000000014c3
	/* C7 */
	.octa 0x800000000007000400000000000011c0
	/* C13 */
...
final_cap_values:
	...
	.octa 0x400000000800000800000000000014c3
	/* C7 */
	.octa 0x80000000000700040000000000001000
	/* C13 */
	.octa 0x800000000000000000000000
	/* C15 */
	.octa 0x0
...
initial_SP_EL0_value:
	.octa 0x40000000740000010000000000001440
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b102 // cvtp c2, x8
	.inst 0xc2c84042 // scvalue c2, c2, x8
	.inst 0x82600c48 // ldr x8, [c2, #0]
	cbnz x8, #28
	mrs x8, ESR_EL1
	.inst 0x82400c48 // str x8, [c2, #0]
	ldr x8, =0x40400414
	mrs x2, ELR_EL1
	sub x8, x8, x2
	cbnz x8, #8
