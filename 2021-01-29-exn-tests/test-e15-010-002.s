...
test_start:
	...
	.inst 0x6c3626a3 // 0x6c3626a3
	.inst 0x782f301f // 0x782f301f
	.inst 0x39ee1412 // 0x39ee1412
	.inst 0x5a010021 // 0x5a010021
	.inst 0xd4000001
	.zero 49144
.text
.global preamble
...
tag_init_end:
	...
	msr cptr_el3, x17
	isb
	ldr q3, =0x100080000000000
	ldr q9, =0x300000000000200
...
.data
check_data2:
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x01, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03
.data
check_data3:
	.zero 16
.data
...
initial_cap_values:
	...
	.octa 0x1008
	/* C1 */
	.octa 0x20408002402200260000000040403fe4
	/* C3 */
	.octa 0x0
	/* C11 */
	.octa 0x0
...
initial_DDC_EL0_value:
	.octa 0xc00000000000000000ffffffffff0001
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_PCC_value:
	.octa 0x20408000402200260000000040404008
