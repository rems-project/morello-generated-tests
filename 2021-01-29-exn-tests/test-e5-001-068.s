...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402d25 // ldr c5, [x9, #11]
	.inst 0xc2c5a681 // chkeq c20, c5
	b.ne comparison_fail
	.inst 0xc2403125 // ldr c5, [x9, #12]
	.inst 0xc2c5a6c1 // chkeq c22, c5
	b.ne comparison_fail
	.inst 0xc2403525 // ldr c5, [x9, #13]
	.inst 0xc2c5a721 // chkeq c25, c5
	b.ne comparison_fail
	.inst 0xc2403925 // ldr c5, [x9, #14]
	.inst 0xc2c5a7a1 // chkeq c29, c5
	b.ne comparison_fail
	.inst 0xc2403d25 // ldr c5, [x9, #15]
...
.section data0, #alloc, #write
	.byte 0x20, 0x14, 0x00, 0x00, 0x30, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 2032
...
initial_cap_values:
	...
	.octa 0x1000
	/* C12 */
	.octa 0xc0000000100700150000000000001bde
	/* C13 */
	.octa 0x0
	/* C14 */
	.octa 0x480000004004c214ff8008000101d6c4
	/* C17 */
	.octa 0xc0000000000300070000000000001800
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000580108040000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x800000006000000200ffffffffffe001
initial_DDC_EL1_value:
	.octa 0xc0000000003080a80000000000000000
initial_VBAR_EL1_value:
	.octa 0x200080004414c41d0000000040400000
final_SP_EL1_value:
	.octa 0x0
final_PCC_value:
