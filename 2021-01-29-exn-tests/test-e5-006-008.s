...
initial_DDC_EL0_value:
	.octa 0x8002000b0000000000000001
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x200080000081c0050000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b0f1 // cvtp c17, x7
	.inst 0xc2c74231 // scvalue c17, c17, x7
	.inst 0x82600e27 // ldr x7, [c17, #0]
	cbnz x7, #28
	mrs x7, ESR_EL1
	.inst 0x82400e27 // str x7, [c17, #0]
	ldr x7, =0x40401414
	mrs x17, ELR_EL1
	sub x7, x7, x17
	cbnz x7, #8
