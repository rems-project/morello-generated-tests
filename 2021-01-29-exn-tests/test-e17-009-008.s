...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2400ee2 // ldr c2, [x23, #3]
	.inst 0xc2c2a561 // chkeq c11, c2
	b.ne comparison_fail
	.inst 0xc24012e2 // ldr c2, [x23, #4]
	.inst 0xc2c2a621 // chkeq c17, c2
	b.ne comparison_fail
	.inst 0xc24016e2 // ldr c2, [x23, #5]
	.inst 0xc2c2a701 // chkeq c24, c2
	b.ne comparison_fail
	.inst 0xc2401ae2 // ldr c2, [x23, #6]
	.inst 0xc2c2a741 // chkeq c26, c2
	b.ne comparison_fail
	.inst 0xc2401ee2 // ldr c2, [x23, #7]
	.inst 0xc2c2a7a1 // chkeq c29, c2
	b.ne comparison_fail
	.inst 0xc24022e2 // ldr c2, [x23, #8]
...
initial_cap_values:
	/* C0 */
	.octa 0x2000800080071fff0000000040407ff5
	/* C1 */
	.octa 0xc0000000000500070000000000001e00
	/* C4 */
	.octa 0x84
	/* C11 */
	...
	.octa 0x100
	/* C26 */
	.octa 0xffffffffffffffffffffffffffffefdf
	/* C29 */
	.octa 0x1020
	/* C30 */
	.octa 0x80100000580400040000000000001400
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0xc0000000000080980000000000000000
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b2e2 // cvtp c2, x23
	.inst 0xc2d74042 // scvalue c2, c2, x23
	.inst 0x82600c57 // ldr x23, [c2, #0]
	cbnz x23, #28
	mrs x23, ESR_EL1
	.inst 0x82400c57 // str x23, [c2, #0]
	ldr x23, =0x40400414
	mrs x2, ELR_EL1
	sub x23, x23, x2
	cbnz x23, #8
