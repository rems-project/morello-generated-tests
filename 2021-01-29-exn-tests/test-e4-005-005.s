...
check_data3:
	...
	.byte 0x1e, 0xd4, 0x49, 0xa8, 0x0b, 0xe4, 0x37, 0xb2, 0xbf, 0x31, 0xc1, 0xc2, 0x1f, 0x13, 0x21, 0x38
	.byte 0xc0, 0x01, 0x1f, 0xd6
.data
check_data4:
	.zero 16
.data
...
final_cap_values:
	...
	.octa 0x0
	/* C11 */
	.octa 0x6666666666666776
	/* C14 */
	.octa 0x40401000
	/* C21 */
	.octa 0x0
	/* C22 */
	.octa 0xc00000000013000700ffe00000000001
	/* C23 */
	.octa 0xffe00000000001
	/* C24 */
	.octa 0x1080
...
initial_SP_EL0_value:
	.octa 0xfffffffffffff6f0
initial_DDC_EL0_value:
	.octa 0xc0000000001300070000000000000001
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_SP_EL0_value:
	.octa 0xfffffffffffff6f0
final_PCC_value:
	.octa 0x20008000501100000000000040401004
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000501100000000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b0bb // cvtp c27, x5
	.inst 0xc2c5437b // scvalue c27, c27, x5
	.inst 0x82600f65 // ldr x5, [c27, #0]
	cbnz x5, #28
	mrs x5, ESR_EL1
	.inst 0x82400f65 // str x5, [c27, #0]
	ldr x5, =0x40401004
	mrs x27, ELR_EL1
	sub x5, x5, x27
	cbnz x5, #8
