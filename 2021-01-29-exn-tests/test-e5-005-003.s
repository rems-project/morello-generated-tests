...
finish:
	...
	.inst 0xc240033e // ldr c30, [x25, #0]
	.inst 0xc2dea401 // chkeq c0, c30
	b.ne comparison_fail
	.inst 0xc240073e // ldr c30, [x25, #1]
	.inst 0xc2dea421 // chkeq c1, c30
	b.ne comparison_fail
	.inst 0xc2400b3e // ldr c30, [x25, #2]
...
final_cap_values:
	...
	.octa 0x1000
	/* C19 */
	.octa 0xffffffff8c731000
	/* C26 */
	.octa 0x0
	/* C29 */
	.octa 0x14c0
initial_DDC_EL0_value:
	.octa 0xc0000000000200050000000000000001
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b33e // cvtp c30, x25
	.inst 0xc2d943de // scvalue c30, c30, x25
	.inst 0x82600fd9 // ldr x25, [c30, #0]
	cbnz x25, #28
	mrs x25, ESR_EL1
	.inst 0x82400fd9 // str x25, [c30, #0]
	ldr x25, =0x40405414
	mrs x30, ELR_EL1
	sub x25, x25, x30
	cbnz x25, #8
