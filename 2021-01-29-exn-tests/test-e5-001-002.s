...
test_start:
	...
	.inst 0xb8e46140 // ldumax:aarch64/instrs/memory/atomicops/ld Rt:0 Rn:10 00:00 opc:110 0:0 Rs:4 1:1 R:1 A:1 111000:111000 size:10
	.inst 0xa86d643d // ldnp_gen:aarch64/instrs/memory/pair/general/no-alloc Rt:29 Rn:1 Rt2:11001 imm7:1011010 L:1 1010000:1010000 opc:10
	.inst 0x485f7fbe // ldxrh:aarch64/instrs/memory/exclusive/single Rt:30 Rn:29 Rt2:11111 o0:0 Rs:11111 0:0 L:1 0010000:0010000 size:01
	.inst 0xd4000001
	.zero 64492
.text
.global preamble
...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24030ef // ldr c15, [x7, #12]
	.inst 0xc2cfa6c1 // chkeq c22, c15
	b.ne comparison_fail
	.inst 0xc24034ef // ldr c15, [x7, #13]
	.inst 0xc2cfa721 // chkeq c25, c15
	b.ne comparison_fail
	.inst 0xc24038ef // ldr c15, [x7, #14]
	.inst 0xc2cfa7a1 // chkeq c29, c15
	b.ne comparison_fail
	.inst 0xc2403cef // ldr c15, [x7, #15]
...
.section data0, #alloc, #write
	.byte 0x00, 0x00, 0x00, 0x00, 0xb0, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
	.zero 8
...
initial_cap_values:
	...
	.octa 0x1080
	/* C12 */
	.octa 0xc00000000001000700000000000017fe
	/* C13 */
	.octa 0x0
	/* C14 */
	.octa 0x800000000080000000000000
	/* C17 */
	.octa 0xc0000000600400200000000000001020
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000500800040000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x8000000054022f220000000040402001
initial_DDC_EL1_value:
	.octa 0xc0000000000100050000000000000001
initial_VBAR_EL1_value:
	.octa 0x20008000400000840000000040400000
final_SP_EL1_value:
	.octa 0x0
final_PCC_value:
	.octa 0x20008000400000840000000040400414
