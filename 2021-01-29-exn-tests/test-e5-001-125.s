...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2403e75 // ldr c21, [x19, #15]
...
initial_cap_values:
	...
	.octa 0x1040
	/* C12 */
	.octa 0xc00000004004000c0000000000001ffc
	/* C13 */
	.octa 0x0
	/* C14 */
	.octa 0x4800000000020003007fffffffffffff
	/* C17 */
	.octa 0xc0000000219200070000000000001800
	/* C20 */
	.octa 0x0
	/* C29 */
...
initial_DDC_EL0_value:
	.octa 0x800000005801040c0000000000000001
initial_DDC_EL1_value:
	.octa 0xc0000000000100050000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080006000e41d0000000040400000
final_SP_EL1_value:
	.octa 0x0
final_PCC_value:
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x200080001c0f00050000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b275 // cvtp c21, x19
	.inst 0xc2d342b5 // scvalue c21, c21, x19
	.inst 0x82600eb3 // ldr x19, [c21, #0]
	cbnz x19, #28
	mrs x19, ESR_EL1
	.inst 0x82400eb3 // str x19, [c21, #0]
	ldr x19, =0x40400414
	mrs x21, ELR_EL1
	sub x19, x19, x21
	cbnz x19, #8
