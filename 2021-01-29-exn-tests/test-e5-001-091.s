...
finish:
	...
	b.ne comparison_fail
	.inst 0xc240330f // ldr c15, [x24, #12]
	.inst 0xc2cfa6c1 // chkeq c22, c15
	b.ne comparison_fail
	.inst 0xc240370f // ldr c15, [x24, #13]
	.inst 0xc2cfa721 // chkeq c25, c15
	b.ne comparison_fail
	.inst 0xc2403b0f // ldr c15, [x24, #14]
	.inst 0xc2cfa7a1 // chkeq c29, c15
	b.ne comparison_fail
	.inst 0xc2403f0f // ldr c15, [x24, #15]
...
.section data0, #alloc, #write
	.byte 0x40, 0x15, 0x00, 0x00, 0xc0, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
...
initial_cap_values:
	...
	/* C17 */
	.octa 0xc0000000600108040000000000001800
	/* C20 */
	.octa 0x4000000000000000000000000000
	/* C29 */
	.octa 0xc00000005042000a0000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x80000000200060000000000000000000
initial_DDC_EL1_value:
	.octa 0xc0000000002600170000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080005000020d0000000040400000
final_SP_EL1_value:
	.octa 0x3fff800000000000000000000000
final_PCC_value:
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x20008000101700070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
