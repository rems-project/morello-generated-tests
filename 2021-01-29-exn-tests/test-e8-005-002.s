...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2401385 // ldr c5, [x28, #4]
	.inst 0xc2c5a5e1 // chkeq c15, c5
	b.ne comparison_fail
	.inst 0xc2401785 // ldr c5, [x28, #5]
...
.section data0, #alloc, #write
	...
	.zero 752
	.byte 0x19, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 3312
.data
check_data0:
	.byte 0xff, 0xff
...
initial_cap_values:
	...
	/* C6 */
	.octa 0x800000000001800500000000404003a0
	/* C15 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000510400000000000000001004
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_SP_EL0_value:
	.octa 0xc0000000000708070000000000001300
initial_DDC_EL0_value:
	.octa 0x200070080004000000000
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_SP_EL0_value:
	.octa 0xc0000000000708070000000000001300
final_PCC_value:
	.octa 0x20008000080000080000000040400028
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000080000080000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b385 // cvtp c5, x28
	.inst 0xc2dc40a5 // scvalue c5, c5, x28
	.inst 0x82600cbc // ldr x28, [c5, #0]
	cbnz x28, #28
	mrs x28, ESR_EL1
	.inst 0x82400cbc // str x28, [c5, #0]
	ldr x28, =0x40400028
	mrs x5, ELR_EL1
	sub x28, x28, x5
	cbnz x28, #8
