...
.section data0, #alloc, #write
	...
	.zero 256
	.byte 0x19, 0x00, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x01, 0x88, 0x00, 0x80, 0x00, 0x20
	.zero 3808
.data
check_data0:
	.byte 0xff
...
initial_cap_values:
	...
	.octa 0x1fc
	/* C7 */
	.octa 0x90100000000300070000000000001100
	/* C17 */
	.octa 0x0
	/* C20 */
	.octa 0x0
	...
	.octa 0x0
	/* C27 */
	.octa 0x40000000000100050000000000001fec
	/* C29 */
	.octa 0xffff
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x0
	/* C30 */
	.octa 0x20008000c80100000000000040400014
initial_DDC_EL0_value:
	.octa 0xd00000005a01100400ffffffffffe001
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_PCC_value:
	.octa 0x2000800008010007000000004040002c
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b1c5 // cvtp c5, x14
	.inst 0xc2ce40a5 // scvalue c5, c5, x14
	.inst 0x82600cae // ldr x14, [c5, #0]
	cbnz x14, #28
	mrs x14, ESR_EL1
	.inst 0x82400cae // str x14, [c5, #0]
	ldr x14, =0x4040002c
	mrs x5, ELR_EL1
	sub x14, x14, x5
	cbnz x14, #8
