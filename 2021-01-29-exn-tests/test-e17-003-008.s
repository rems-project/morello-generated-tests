...
.data
check_data2:
	.byte 0x33, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40
...
initial_cap_values:
	...
	.octa 0x1a00
	/* C4 */
	.octa 0xc0000000000400070000000000001378
	/* C6 */
	.octa 0x40000000000000000000000000001033
	/* C11 */
	.octa 0x1000
	/* C17 */
	.octa 0x8001800f0080000000010001
	/* C21 */
	.octa 0x1000
	/* C26 */
	.octa 0x3a000002000000000000000000
	/* C29 */
	.octa 0x8600050000000000000001
	/* C30 */
	.octa 0xff000000
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x3a000002000000000000000000
	/* C29 */
	.octa 0x700050000000000078001
	/* C30 */
	.octa 0xff000000
initial_SP_EL1_value:
	.octa 0x700050000000000078001
initial_DDC_EL0_value:
	.octa 0xcc0000005c02000000ffffffffffe003
initial_VBAR_EL1_value:
	.octa 0x200080006000001d0000000040400001
final_SP_EL1_value:
	.octa 0x8001800f0080000000010000
final_PCC_value:
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b070 // cvtp c16, x3
	.inst 0xc2c34210 // scvalue c16, c16, x3
	.inst 0x82600e03 // ldr x3, [c16, #0]
	cbnz x3, #28
	mrs x3, ESR_EL1
	.inst 0x82400e03 // str x3, [c16, #0]
	ldr x3, =0x40400414
	mrs x16, ELR_EL1
	sub x3, x3, x16
	cbnz x3, #8
