...
tag_init_end:
	...
	msr cptr_el3, x16
	isb
	ldr q15, =0x200000000020002000202000000
...
finish:
	...
	ldr x16, =0x2000202000000
	mov x2, v15.d[0]
	cmp x16, x2
	b.ne comparison_fail
	ldr x16, =0x20000000002
	mov x2, v15.d[1]
	cmp x16, x2
	b.ne comparison_fail
...
.data
check_data0:
	.byte 0x00, 0x00, 0x00, 0x02, 0x02, 0x00, 0x02, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00
.data
check_data1:
	.zero 16
.data
...
initial_cap_values:
	...
	.octa 0x1009
	/* C6 */
	.octa 0xcc100000410101c40000000000001000
	/* C8 */
	.octa 0x1000
	/* C20 */
...
initial_SP_EL0_value:
	.octa 0xf001da000000000
initial_SP_EL1_value:
	.octa 0x0
initial_DDC_EL1_value:
	.octa 0xd01000000007008700ffffffffffe000
initial_VBAR_EL1_value:
	.octa 0x200080004418001c0000000040400000
final_SP_EL0_value:
	.octa 0xf001da000000000
final_SP_EL1_value:
	.octa 0x0
final_PCC_value:
	.octa 0x200080004418001c0000000040400414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000100100050000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
