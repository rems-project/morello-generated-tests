...
initial_cap_values:
	/* C1 */
	.octa 0xdc100000000200010000000000001000
	/* C4 */
	.octa 0x1000
	/* C10 */
	.octa 0x200080000000000000000000404003fd
	/* C13 */
	.octa 0x1e5c9ffc
	/* C16 */
	.octa 0x8000000000410803e100022ffffffffa
	/* C17 */
	.octa 0xff
	/* C29 */
	.octa 0x800000000007801000000000404000c0
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x10f1f000
	/* C30 */
	.octa 0x20008000400c0000000000004040000d
initial_DDC_EL1_value:
	.octa 0xc0000000000100050000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080005004101d0000000040404000
final_PCC_value:
	.octa 0x200080005004101d0000000040404414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000400c00000000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b266 // cvtp c6, x19
	.inst 0xc2d340c6 // scvalue c6, c6, x19
	.inst 0x82600cd3 // ldr x19, [c6, #0]
	cbnz x19, #28
	mrs x19, ESR_EL1
	.inst 0x82400cd3 // str x19, [c6, #0]
	ldr x19, =0x40404414
	mrs x6, ELR_EL1
	sub x19, x19, x6
	cbnz x19, #8
