...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402ce5 // ldr c5, [x7, #11]
	.inst 0xc2c5a681 // chkeq c20, c5
	b.ne comparison_fail
	.inst 0xc24030e5 // ldr c5, [x7, #12]
	.inst 0xc2c5a6c1 // chkeq c22, c5
	b.ne comparison_fail
	.inst 0xc24034e5 // ldr c5, [x7, #13]
	.inst 0xc2c5a721 // chkeq c25, c5
	b.ne comparison_fail
	.inst 0xc24038e5 // ldr c5, [x7, #14]
	.inst 0xc2c5a7a1 // chkeq c29, c5
	b.ne comparison_fail
	.inst 0xc2403ce5 // ldr c5, [x7, #15]
...
.section data0, #alloc, #write
	...
	.zero 1536
	.byte 0x00, 0x00, 0x20, 0x00, 0xd0, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 16
...
initial_cap_values:
	...
	/* C14 */
	.octa 0x4000000015fb97fb007ffffffffffff1
	/* C17 */
	.octa 0xc00000004000019c0000000000001100
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc00000005fa800040000000000001f80
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x80000000040680800000000040000001
initial_DDC_EL1_value:
	.octa 0xc00000000d1900050000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080006400001d0000000040400000
final_SP_EL1_value:
	.octa 0x3fff800000000000000000000000
final_PCC_value:
	.octa 0x200080006400001d0000000040400414
