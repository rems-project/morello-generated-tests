...
finish:
	...
	.inst 0xc2400097 // ldr c23, [x4, #0]
	.inst 0xc2d7a421 // chkeq c1, c23
	b.ne comparison_fail
	.inst 0xc2400497 // ldr c23, [x4, #1]
...
check_data5:
	...
	.byte 0x7f, 0xff, 0x5f, 0x42, 0xa2, 0x50, 0xc2, 0xc2, 0xc1, 0xa4, 0xc1, 0xc2, 0xbe, 0xf2, 0xea, 0xe2
	.byte 0x3f, 0x40, 0x61, 0x78, 0x01, 0x00, 0x00, 0xd4
.data
check_data6:
	.zero 16
...
initial_cap_values:
	...
	.octa 0x1000
	/* C5 */
	.octa 0x20008000500100050000000040400018
	/* C13 */
	.octa 0x90000000000100050000000000001390
	/* C21 */
	.octa 0x40000000000100050000000000001011
	/* C27 */
	.octa 0x4040ffe0
	/* C29 */
	.octa 0x258
...
initial_DDC_EL0_value:
	.octa 0xd0000000000940050080000000000001
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x20008000000e000f0000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b097 // cvtp c23, x4
	.inst 0xc2c442f7 // scvalue c23, c23, x4
	.inst 0x82600ee4 // ldr x4, [c23, #0]
	cbnz x4, #28
	mrs x4, ESR_EL1
	.inst 0x82400ee4 // str x4, [c23, #0]
	ldr x4, =0x40400028
	mrs x23, ELR_EL1
	sub x4, x4, x23
	cbnz x4, #8
