...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24029a0 // ldr c0, [x13, #10]
	.inst 0xc2c0a761 // chkeq c27, c0
	b.ne comparison_fail
	.inst 0xc2402da0 // ldr c0, [x13, #11]
	.inst 0xc2c0a781 // chkeq c28, c0
	b.ne comparison_fail
	.inst 0xc24031a0 // ldr c0, [x13, #12]
...
.data
check_data0:
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x71, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xb9
.data
check_data1:
	.zero 4
.data
...
initial_cap_values:
	...
	.octa 0x2002
	/* C4 */
	.octa 0xb9000000000000000071000000000004
	/* C15 */
	.octa 0x12ec
	/* C16 */
	.octa 0xf80
...
initial_DDC_EL0_value:
	.octa 0xdc000000600200040000000000000000
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b1a0 // cvtp c0, x13
	.inst 0xc2cd4000 // scvalue c0, c0, x13
	.inst 0x82600c0d // ldr x13, [c0, #0]
	cbnz x13, #28
	mrs x13, ESR_EL1
	.inst 0x82400c0d // str x13, [c0, #0]
	ldr x13, =0x40400414
	mrs x0, ELR_EL1
	sub x13, x13, x0
	cbnz x13, #8
