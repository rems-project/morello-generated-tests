...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24032ef // ldr c15, [x23, #12]
	.inst 0xc2cfa6c1 // chkeq c22, c15
	b.ne comparison_fail
	.inst 0xc24036ef // ldr c15, [x23, #13]
	.inst 0xc2cfa721 // chkeq c25, c15
	b.ne comparison_fail
	.inst 0xc2403aef // ldr c15, [x23, #14]
	.inst 0xc2cfa7a1 // chkeq c29, c15
	b.ne comparison_fail
	.inst 0xc2403eef // ldr c15, [x23, #15]
...
.section data0, #alloc, #write
	.byte 0x88, 0x02, 0x00, 0x01, 0x30, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
...
initial_cap_values:
	...
	.octa 0x1000
	/* C12 */
	.octa 0xc00000005004000c0000000000001000
	/* C13 */
	.octa 0x3fff800000000000000000000000
	/* C14 */
	.octa 0x0
	/* C17 */
	.octa 0xc0000000521404040000000000001000
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000080700030000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x20008000100503140000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b2ef // cvtp c15, x23
	.inst 0xc2d741ef // scvalue c15, c15, x23
	.inst 0x82600df7 // ldr x23, [c15, #0]
	cbnz x23, #28
	mrs x23, ESR_EL1
	.inst 0x82400df7 // str x23, [c15, #0]
	ldr x23, =0x40400414
	mrs x15, ELR_EL1
	sub x23, x23, x15
	cbnz x23, #8
