...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2403249 // ldr c9, [x18, #12]
	.inst 0xc2c9a6c1 // chkeq c22, c9
	b.ne comparison_fail
	.inst 0xc2403649 // ldr c9, [x18, #13]
	.inst 0xc2c9a721 // chkeq c25, c9
	b.ne comparison_fail
	.inst 0xc2403a49 // ldr c9, [x18, #14]
	.inst 0xc2c9a7a1 // chkeq c29, c9
	b.ne comparison_fail
	.inst 0xc2403e49 // ldr c9, [x18, #15]
...
.section data0, #alloc, #write
	.zero 512
	.byte 0x20, 0x00, 0x00, 0x01, 0x30, 0x13, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 3568
.data
check_data0:
	.zero 2
...
initial_cap_values:
	...
	.octa 0x1200
	/* C12 */
	.octa 0xc0000000500102040000000000001000
	/* C13 */
	.octa 0x0
	/* C14 */
	.octa 0x4c0000001801188e32fffffffffffffe
	/* C17 */
	.octa 0xc0000000600000010000000000001800
	/* C20 */
	.octa 0x4000000000000000000000000000
	/* C29 */
	.octa 0xc00000000000c0000000000000001200
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x800000000c0740070000000040408001
