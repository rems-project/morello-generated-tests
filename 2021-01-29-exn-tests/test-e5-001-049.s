...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24034da // ldr c26, [x6, #13]
	.inst 0xc2daa721 // chkeq c25, c26
	b.ne comparison_fail
	.inst 0xc24038da // ldr c26, [x6, #14]
	.inst 0xc2daa7a1 // chkeq c29, c26
	b.ne comparison_fail
	.inst 0xc2403cda // ldr c26, [x6, #15]
...
.section data0, #alloc, #write
	...
	.zero 240
	.byte 0x00, 0x20, 0x00, 0x00, 0x04, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 3520
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 288
.data
check_data0:
...
initial_cap_values:
	...
	/* C14 */
	.octa 0x4c00000048042554ff80000301f02812
	/* C17 */
	.octa 0xc0000000502400010000000000001020
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000400201400000000000001100
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x800000001050c800000000000000f000
initial_DDC_EL1_value:
	.octa 0xc00000007802000400ffffffffffe801
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x20008000020784070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
