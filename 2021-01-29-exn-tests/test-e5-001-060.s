...
.section data0, #alloc, #write
	.byte 0x00, 0x20, 0x00, 0x00, 0x30, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 496
...
initial_cap_values:
	...
	.octa 0x1000
	/* C12 */
	.octa 0xc00000004004002100000000000017fb
	/* C13 */
	.octa 0x3fff800000000000000000000000
	/* C14 */
	.octa 0x4c000000000b802700100007ffffffe8
	/* C17 */
	.octa 0xc000000058040c070000000000001200
	/* C20 */
	.octa 0x0
	/* C29 */
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x20008000000fa0010000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b0f3 // cvtp c19, x7
	.inst 0xc2c74273 // scvalue c19, c19, x7
	.inst 0x82600e67 // ldr x7, [c19, #0]
	cbnz x7, #28
	mrs x7, ESR_EL1
	.inst 0x82400e67 // str x7, [c19, #0]
	ldr x7, =0x40400414
	mrs x19, ELR_EL1
	sub x7, x7, x19
	cbnz x7, #8
