...
.data
check_data1:
	.byte 0x00, 0x00, 0x00, 0x00, 0x14, 0x91, 0x48, 0x04
.data
check_data2:
	.byte 0xff
.data
...
initial_cap_values:
	/* C0 */
	.octa 0x2ffffffffffffff
	/* C1 */
	.octa 0x0
	/* C9 */
	.octa 0x0
	/* C14 */
	.octa 0x800000000101c0050000000000001000
	/* C16 */
	.octa 0xf
	/* C19 */
	.octa 0x1000
...
final_cap_values:
	...
	.octa 0x1
	/* C30 */
	.octa 0x2000800048004c2d0000000040408411
initial_SP_EL0_value:
	.octa 0x400000000000800800000000000019d0
initial_SP_EL1_value:
	.octa 0x400000006004001a0000000000001000
initial_DDC_EL0_value:
	.octa 0xc0000000300200030080000000000001
initial_VBAR_EL1_value:
	.octa 0x2000800048004c2d0000000040408001
final_SP_EL0_value:
	.octa 0x400000000000800800000000000019d0
final_SP_EL1_value:
	.octa 0x400000006004001a0000000000001000
final_PCC_value:
	.octa 0x2000800048004c2d0000000040408030
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000000020100000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b37a // cvtp c26, x27
	.inst 0xc2db435a // scvalue c26, c26, x27
	.inst 0x82600f5b // ldr x27, [c26, #0]
	cbnz x27, #28
	mrs x27, ESR_EL1
	.inst 0x82400f5b // str x27, [c26, #0]
	ldr x27, =0x40408030
	mrs x26, ELR_EL1
	sub x27, x27, x26
	cbnz x27, #8
