...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402233 // ldr c19, [x17, #8]
	.inst 0xc2d3a6a1 // chkeq c21, c19
	b.ne comparison_fail
	.inst 0xc2402633 // ldr c19, [x17, #9]
	.inst 0xc2d3a6c1 // chkeq c22, c19
	b.ne comparison_fail
	.inst 0xc2402a33 // ldr c19, [x17, #10]
	.inst 0xc2d3a7a1 // chkeq c29, c19
	b.ne comparison_fail
	.inst 0xc2402e33 // ldr c19, [x17, #11]
...
.section data0, #alloc, #write
	.zero 544
	.byte 0x0c, 0x80, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0x01, 0x80, 0x10, 0x40, 0x00, 0x80, 0x00, 0x20
	.zero 1616
	.byte 0x81, 0x00, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x11, 0x80, 0x00, 0x80, 0x00, 0x20
	.zero 1904
.data
check_data0:
	.zero 1
...
initial_cap_values:
	...
	.octa 0x0
	/* C14 */
	.octa 0x9000000040000ff40000000000001870
	/* C29 */
...
initial_DDC_EL0_value:
	.octa 0x40000000000081000000000000000000
initial_DDC_EL1_value:
	.octa 0x80000000780010000000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080005000000d0000000040400001
final_PCC_value:
	.octa 0x20008000401080010000000040408010
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000201180050000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
