...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402970 // ldr c16, [x11, #10]
	.inst 0xc2d0a621 // chkeq c17, c16
	b.ne comparison_fail
	.inst 0xc2402d70 // ldr c16, [x11, #11]
	.inst 0xc2d0a681 // chkeq c20, c16
	b.ne comparison_fail
	.inst 0xc2403170 // ldr c16, [x11, #12]
	.inst 0xc2d0a6c1 // chkeq c22, c16
	b.ne comparison_fail
	.inst 0xc2403570 // ldr c16, [x11, #13]
	.inst 0xc2d0a721 // chkeq c25, c16
	b.ne comparison_fail
	.inst 0xc2403970 // ldr c16, [x11, #14]
	.inst 0xc2d0a7a1 // chkeq c29, c16
	b.ne comparison_fail
	.inst 0xc2403d70 // ldr c16, [x11, #15]
...
.section data0, #alloc, #write
	...
	.zero 192
	.byte 0x00, 0x02, 0x00, 0x00, 0x00, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 2816
...
initial_cap_values:
	...
	.octa 0x1be0
	/* C12 */
	.octa 0xc0000000400400440000000000001000
	/* C13 */
	.octa 0x0
	/* C14 */
	.octa 0x48000000000b800a001800ffffffffe1
	/* C17 */
	.octa 0xc0000000600000220000000000001000
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc00000005401040400000000000010d0
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x80000000000702860000000000000005
initial_DDC_EL1_value:
	.octa 0xc00000001ffa00050000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080004500c51d0000000040400000
final_SP_EL1_value:
	.octa 0x0
final_PCC_value:
	.octa 0x200080004500c51d0000000040400414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000030300070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
