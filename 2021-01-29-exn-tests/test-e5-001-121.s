...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24031fa // ldr c26, [x15, #12]
	.inst 0xc2daa6c1 // chkeq c22, c26
	b.ne comparison_fail
	.inst 0xc24035fa // ldr c26, [x15, #13]
	.inst 0xc2daa721 // chkeq c25, c26
	b.ne comparison_fail
	.inst 0xc24039fa // ldr c26, [x15, #14]
	.inst 0xc2daa7a1 // chkeq c29, c26
	b.ne comparison_fail
	.inst 0xc2403dfa // ldr c26, [x15, #15]
...
.section data0, #alloc, #write
	.byte 0x20, 0x00, 0x60, 0x00, 0x30, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
...
initial_cap_values:
	...
	.octa 0x1000
	/* C12 */
	.octa 0xc0000000201700270000000000001000
	/* C13 */
	.octa 0x3fff800000000000000000000000
	/* C14 */
	.octa 0x80000000000000000000000000
	/* C17 */
	.octa 0xc0000000600000010000000000001040
	/* C20 */
	.octa 0x0
	/* C29 */
...
initial_DDC_EL1_value:
	.octa 0xc0000000000600020000000000008801
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x200080000287c0c30000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b1fa // cvtp c26, x15
	.inst 0xc2cf435a // scvalue c26, c26, x15
	.inst 0x82600f4f // ldr x15, [c26, #0]
	cbnz x15, #28
	mrs x15, ESR_EL1
	.inst 0x82400f4f // str x15, [c26, #0]
	ldr x15, =0x40400414
	mrs x26, ELR_EL1
	sub x15, x15, x26
	cbnz x15, #8
