...
finish:
	...
	b.ne comparison_fail
	.inst 0xc240336f // ldr c15, [x27, #12]
	.inst 0xc2cfa6c1 // chkeq c22, c15
	b.ne comparison_fail
	.inst 0xc240376f // ldr c15, [x27, #13]
	.inst 0xc2cfa721 // chkeq c25, c15
	b.ne comparison_fail
	.inst 0xc2403b6f // ldr c15, [x27, #14]
	.inst 0xc2cfa7a1 // chkeq c29, c15
	b.ne comparison_fail
	.inst 0xc2403f6f // ldr c15, [x27, #15]
...
.section data0, #alloc, #write
	.byte 0x00, 0x00, 0x00, 0x04, 0x00, 0x00, 0x41, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
	.zero 8
...
initial_cap_values:
	...
	/* C14 */
	.octa 0x4800000000472007ffa20a0020002002
	/* C17 */
	.octa 0xc00000005004010a0000000000001000
	/* C20 */
	.octa 0x0
	/* C29 */
...
initial_VBAR_EL1_value:
	.octa 0x20008000500002010000000040400000
final_SP_EL1_value:
	.octa 0x3fff800000000000000000000000
final_PCC_value:
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b36f // cvtp c15, x27
	.inst 0xc2db41ef // scvalue c15, c15, x27
	.inst 0x82600dfb // ldr x27, [c15, #0]
	cbnz x27, #28
	mrs x27, ESR_EL1
	.inst 0x82400dfb // str x27, [c15, #0]
	ldr x27, =0x40400414
	mrs x15, ELR_EL1
	sub x27, x27, x15
	cbnz x27, #8
