...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24028c9 // ldr c9, [x6, #10]
	.inst 0xc2c9a621 // chkeq c17, c9
	b.ne comparison_fail
	.inst 0xc2402cc9 // ldr c9, [x6, #11]
	.inst 0xc2c9a681 // chkeq c20, c9
	b.ne comparison_fail
	.inst 0xc24030c9 // ldr c9, [x6, #12]
	.inst 0xc2c9a6c1 // chkeq c22, c9
	b.ne comparison_fail
	.inst 0xc24034c9 // ldr c9, [x6, #13]
	.inst 0xc2c9a721 // chkeq c25, c9
	b.ne comparison_fail
	.inst 0xc24038c9 // ldr c9, [x6, #14]
	.inst 0xc2c9a7a1 // chkeq c29, c9
	b.ne comparison_fail
	.inst 0xc2403cc9 // ldr c9, [x6, #15]
...
.section data0, #alloc, #write
	...
	.zero 112
	.byte 0x00, 0x00, 0x80, 0x00, 0x30, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 112
.data
check_data0:
...
initial_cap_values:
	...
	.octa 0x1000
	/* C12 */
	.octa 0xc00000000009c0050000000000001000
	/* C13 */
	.octa 0x3fff800000000000000000000000
	/* C14 */
	.octa 0x4c00000060422042000000810002e041
	/* C17 */
	.octa 0xc0000000200900050000000000001100
	/* C20 */
	.octa 0x0
	/* C29 */
	.octa 0xc0000000000700070000000000001f80
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x800000000807021300000000404c0003
initial_DDC_EL1_value:
	.octa 0xc00000000006000200fffffffc000000
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x20008000001600070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
