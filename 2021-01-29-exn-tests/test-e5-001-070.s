...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24036a7 // ldr c7, [x21, #13]
	.inst 0xc2c7a721 // chkeq c25, c7
	b.ne comparison_fail
	.inst 0xc2403aa7 // ldr c7, [x21, #14]
	.inst 0xc2c7a7a1 // chkeq c29, c7
	b.ne comparison_fail
	.inst 0xc2403ea7 // ldr c7, [x21, #15]
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b2a7 // cvtp c7, x21
	.inst 0xc2d540e7 // scvalue c7, c7, x21
	.inst 0x82600cf5 // ldr x21, [c7, #0]
	cbnz x21, #28
	mrs x21, ESR_EL1
	.inst 0x82400cf5 // str x21, [c7, #0]
	ldr x21, =0x40400414
	mrs x7, ELR_EL1
	sub x21, x21, x7
	cbnz x21, #8
