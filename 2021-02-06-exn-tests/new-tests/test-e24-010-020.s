...
.section data0, #alloc, #write
	...
	.byte 0x1a, 0x00, 0x41, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x01, 0x01, 0x00, 0x00
	.zero 1856
...
final_PCC_value:
	.octa 0x20008000000500570000000040400028
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000000500570000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b29a // cvtp c26, x20
	.inst 0xc2d4435a // scvalue c26, c26, x20
	.inst 0x82600f54 // ldr x20, [c26, #0]
	cbnz x20, #28
	mrs x20, ESR_EL1
	.inst 0x82400f54 // str x20, [c26, #0]
	ldr x20, =0x40400028
	mrs x26, ELR_EL1
	sub x20, x20, x26
	cbnz x20, #8
