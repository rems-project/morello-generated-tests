...
check_data3:
	...
	.byte 0x8d, 0x98, 0x4a, 0x3d, 0x4e, 0x13, 0x5e, 0xba, 0xc2, 0xff, 0x07, 0x08, 0x5f, 0x82, 0x2f, 0x9b
	.byte 0xff, 0x53, 0x6c, 0x38, 0x01, 0x00, 0x00, 0xd4
.data
check_data4:
	.zero 1
...
initial_cap_values:
	/* C0 */
	.octa 0xc8000000000b00070000000000001088
	/* C1 */
	.octa 0x40100
	/* C4 */
	.octa 0x8000000060c220610000000040401e00
	/* C10 */
...
final_cap_values:
	/* C0 */
	.octa 0xc8000000000b00070000000000001070
	/* C1 */
	.octa 0x40100
	/* C4 */
	.octa 0x8000000060c220610000000040401e00
...
initial_SP_EL0_value:
	.octa 0xc000000070250caa0000000000001410
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_SP_EL0_value:
	.octa 0xc000000070250caa0000000000001410
final_PCC_value:
	.octa 0x200080001ff900070000000040400028
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b306 // cvtp c6, x24
	.inst 0xc2d840c6 // scvalue c6, c6, x24
	.inst 0x82600cd8 // ldr x24, [c6, #0]
	cbnz x24, #28
	mrs x24, ESR_EL1
	.inst 0x82400cd8 // str x24, [c6, #0]
	ldr x24, =0x40400028
	mrs x6, ELR_EL1
	sub x24, x24, x6
	cbnz x24, #8
