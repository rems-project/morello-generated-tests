...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2400921 // ldr c1, [x9, #2]
	.inst 0xc2c1a5a1 // chkeq c13, c1
	b.ne comparison_fail
	.inst 0xc2400d21 // ldr c1, [x9, #3]
	.inst 0xc2c1a5e1 // chkeq c15, c1
	b.ne comparison_fail
	.inst 0xc2401121 // ldr c1, [x9, #4]
	.inst 0xc2c1a621 // chkeq c17, c1
	b.ne comparison_fail
	.inst 0xc2401521 // ldr c1, [x9, #5]
	.inst 0xc2c1a6e1 // chkeq c23, c1
	b.ne comparison_fail
	.inst 0xc2401921 // ldr c1, [x9, #6]
	.inst 0xc2c1a701 // chkeq c24, c1
	b.ne comparison_fail
	.inst 0xc2401d21 // ldr c1, [x9, #7]
...
initial_cap_values:
	...
	/* C10 */
	.octa 0x800000000007000f000000000000107c
	/* C17 */
	.octa 0x20008000907d107f0000000040401001
	/* C23 */
	.octa 0x800040000001400d00800000000000c6
	/* C24 */
...
final_cap_values:
	...
	/* C13 */
	.octa 0x20008000107d107fffffffffe18a3000
	/* C15 */
...
initial_DDC_EL0_value:
	.octa 0xd81000000002000700e0000000000001
initial_VBAR_EL1_value:
	.octa 0x200080004000c401000000004040d000
final_PCC_value:
	.octa 0x20008000107d107f0000000040401010
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000003e80400000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x9, =esr_el1_dump_address
	.inst 0xc2c5b121 // cvtp c1, x9
	.inst 0xc2c94021 // scvalue c1, c1, x9
	.inst 0x82600c29 // ldr x9, [c1, #0]
	cbnz x9, #28
	mrs x9, ESR_EL1
	.inst 0x82400c29 // str x9, [c1, #0]
	ldr x9, =0x40401010
	mrs x1, ELR_EL1
	sub x9, x9, x1
	cbnz x9, #8
