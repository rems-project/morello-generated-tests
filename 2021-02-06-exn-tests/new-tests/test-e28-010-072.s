...
.data
check_data0:
	.byte 0x00, 0x00, 0x00, 0x02, 0x02, 0x00, 0x02, 0x00
.data
check_data1:
	.zero 2
.data
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b3bc // cvtp c28, x29
	.inst 0xc2dd439c // scvalue c28, c28, x29
	.inst 0x82600f9d // ldr x29, [c28, #0]
	cbnz x29, #28
	mrs x29, ESR_EL1
	.inst 0x82400f9d // str x29, [c28, #0]
	ldr x29, =0x40400028
	mrs x28, ELR_EL1
	sub x29, x29, x28
	cbnz x29, #8
