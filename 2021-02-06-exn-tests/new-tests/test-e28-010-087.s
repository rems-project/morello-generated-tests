...
tag_init_end:
	...
	ldr x29, =initial_DDC_EL1_value
	.inst 0xc24003bd // ldr c29, [x29, #0]
	.inst 0xc28c413d // msr DDC_EL1, c29
	ldr x29, =0x80000000
	msr HCR_EL2, x29
	isb
	/* Start test */
...
initial_cap_values:
	...
	.octa 0xf45
	/* C18 */
	.octa 0x20000000800300070000000040404001
	/* C30 */
	.octa 0x1000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0xc0000000511000040000000000004003
initial_DDC_EL1_value:
	.octa 0xc000000050200fec0000000000000001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x29, =esr_el1_dump_address
	.inst 0xc2c5b3b7 // cvtp c23, x29
	.inst 0xc2dd42f7 // scvalue c23, c23, x29
	.inst 0x82600efd // ldr x29, [c23, #0]
	cbnz x29, #28
	mrs x29, ESR_EL1
	.inst 0x82400efd // str x29, [c23, #0]
	ldr x29, =0x40400414
	mrs x23, ELR_EL1
	sub x29, x29, x23
	cbnz x29, #8
