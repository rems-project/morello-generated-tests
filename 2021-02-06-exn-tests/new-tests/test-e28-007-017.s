...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2400981 // ldr c1, [x12, #2]
	.inst 0xc2c1a5a1 // chkeq c13, c1
	b.ne comparison_fail
	.inst 0xc2400d81 // ldr c1, [x12, #3]
	.inst 0xc2c1a681 // chkeq c20, c1
	b.ne comparison_fail
	.inst 0xc2401181 // ldr c1, [x12, #4]
	.inst 0xc2c1a6c1 // chkeq c22, c1
	b.ne comparison_fail
	.inst 0xc2401581 // ldr c1, [x12, #5]
	.inst 0xc2c1a701 // chkeq c24, c1
	b.ne comparison_fail
	.inst 0xc2401981 // ldr c1, [x12, #6]
...
.section data0, #alloc, #write
	.byte 0x00, 0x04, 0x00, 0x00, 0x00, 0x00, 0x80, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
	.zero 16
...
initial_cap_values:
	/* C0 */
	.octa 0xdc000000600200050000000000001000
	/* C5 */
	.octa 0xfffffffffffff19e
	/* C13 */
	.octa 0x0
	/* C29 */
	.octa 0x40000000600107c20000000000001800
	/* C30 */
	.octa 0x0
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x0
	/* C20 */
	.octa 0x200080004800d01580800000403fd415
	/* C22 */
	.octa 0x0
	/* C24 */
	.octa 0x0
...
initial_DDC_EL0_value:
	.octa 0x8000000060728a750000400800008001
initial_DDC_EL1_value:
	.octa 0x400000000007000e00ffffffffffc001
initial_VBAR_EL1_value:
	.octa 0x200080004800d0150000000040400001
final_PCC_value:
	.octa 0x200080004800d0150000000040400414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000404200000000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x12, =esr_el1_dump_address
	.inst 0xc2c5b181 // cvtp c1, x12
	.inst 0xc2cc4021 // scvalue c1, c1, x12
	.inst 0x82600c2c // ldr x12, [c1, #0]
	cbnz x12, #28
	mrs x12, ESR_EL1
	.inst 0x82400c2c // str x12, [c1, #0]
	ldr x12, =0x40400414
	mrs x1, ELR_EL1
	sub x12, x12, x1
	cbnz x12, #8
