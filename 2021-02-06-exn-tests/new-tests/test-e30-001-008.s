...
initial_cap_values:
	...
	.octa 0x40401003
	/* C23 */
	.octa 0xffffffffffffd1
	/* C26 */
	.octa 0x20008000000100050000000040400010
	/* C30 */
	.octa 0x8a4
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL1_value:
	.octa 0x800000000007022d00000000403f8001
initial_VBAR_EL1_value:
	.octa 0x200080004000c40d000000004040e000
final_PCC_value:
	.octa 0x200080004000c40d000000004040e414
...
.section vector_table_el1, #alloc, #execinstr
	ldr x5, =esr_el1_dump_address
	.inst 0xc2c5b0ae // cvtp c14, x5
	.inst 0xc2c541ce // scvalue c14, c14, x5
	.inst 0x82600dc5 // ldr x5, [c14, #0]
	cbnz x5, #28
	mrs x5, ESR_EL1
	.inst 0x82400dc5 // str x5, [c14, #0]
	ldr x5, =0x4040e414
	mrs x14, ELR_EL1
	sub x5, x5, x14
	cbnz x5, #8
