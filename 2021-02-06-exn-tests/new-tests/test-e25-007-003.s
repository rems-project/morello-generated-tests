...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2400ac1 // ldr c1, [x22, #2]
	.inst 0xc2c1a4c1 // chkeq c6, c1
	b.ne comparison_fail
	.inst 0xc2400ec1 // ldr c1, [x22, #3]
	.inst 0xc2c1a501 // chkeq c8, c1
	b.ne comparison_fail
	.inst 0xc24012c1 // ldr c1, [x22, #4]
	.inst 0xc2c1a541 // chkeq c10, c1
	b.ne comparison_fail
	.inst 0xc24016c1 // ldr c1, [x22, #5]
	.inst 0xc2c1a581 // chkeq c12, c1
	b.ne comparison_fail
	.inst 0xc2401ac1 // ldr c1, [x22, #6]
	.inst 0xc2c1a5e1 // chkeq c15, c1
	b.ne comparison_fail
	.inst 0xc2401ec1 // ldr c1, [x22, #7]
	.inst 0xc2c1a621 // chkeq c17, c1
	b.ne comparison_fail
	.inst 0xc24022c1 // ldr c1, [x22, #8]
	.inst 0xc2c1a7c1 // chkeq c30, c1
	b.ne comparison_fail
	/* Check system registers */
	ldr x22, =final_SP_EL1_value
	.inst 0xc24002d6 // ldr c22, [x22, #0]
	.inst 0xc29c4101 // mrs c1, CSP_EL1
...
.data
check_data0:
	.byte 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x80
.data
check_data1:
	.zero 4
.data
...
initial_cap_values:
	...
	/* C5 */
	.octa 0xc0000000000100050000000000001098
	/* C6 */
	.octa 0x901000000003000700000000403fc000
	/* C8 */
	.octa 0x20000
	/* C10 */
	.octa 0x80000000
	/* C12 */
	.octa 0x20000000851705150000000040403404
	/* C15 */
	.octa 0x109c
	/* C17 */
	.octa 0x7fffffffffff5c
	/* C30 */
	.octa 0x1401
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x80000000
	/* C12 */
	.octa 0x20008000100f0007190000004040000d
	/* C15 */
	.octa 0x109c
	/* C17 */
	.octa 0x7fffffffffff5c
...
initial_VBAR_EL1_value:
	.octa 0x200080006500a400000000004040a001
final_SP_EL1_value:
	.octa 0x40000000000100050000000000000f50
final_PCC_value:
	.octa 0x200080006500a400000000004040a414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000100f00070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x22, =esr_el1_dump_address
	.inst 0xc2c5b2c1 // cvtp c1, x22
	.inst 0xc2d64021 // scvalue c1, c1, x22
	.inst 0x82600c36 // ldr x22, [c1, #0]
	cbnz x22, #28
	mrs x22, ESR_EL1
	.inst 0x82400c36 // str x22, [c1, #0]
	ldr x22, =0x4040a414
	mrs x1, ELR_EL1
	sub x22, x22, x1
	cbnz x22, #8
