...
.section data0, #alloc, #write
	...
	.zero 432
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xf4, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 1600
	.byte 0x54, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 2016
.data
check_data0:
	.byte 0x02
...
initial_cap_values:
	...
	.octa 0x1142
	/* C1 */
	.octa 0x80000000218120073c00000000009e51
	/* C4 */
	.octa 0x0
	/* C6 */
	.octa 0x0
	...
	.octa 0xf3d
	/* C21 */
	.octa 0x8000000000010005000000004040f8c7
	/* C29 */
	.octa 0x1000
	/* C30 */
	.octa 0x200080002001c0050000000040400081
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0xc0000000300000000000000000000000
initial_DDC_EL1_value:
	.octa 0xc0000000604208100000000000008001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x3, =esr_el1_dump_address
	.inst 0xc2c5b07c // cvtp c28, x3
	.inst 0xc2c3439c // scvalue c28, c28, x3
	.inst 0x82600f83 // ldr x3, [c28, #0]
	cbnz x3, #28
	mrs x3, ESR_EL1
	.inst 0x82400f83 // str x3, [c28, #0]
	ldr x3, =0x40400414
	mrs x28, ELR_EL1
	sub x3, x3, x28
	cbnz x3, #8
