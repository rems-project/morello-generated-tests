...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24029b2 // ldr c18, [x13, #10]
...
initial_cap_values:
	...
	.octa 0x0
	/* C6 */
	.octa 0x400000002001c005000000000000105c
	/* C10 */
	.octa 0x0
	/* C22 */
	.octa 0x800000000006400f0000000040401000
	/* C23 */
	.octa 0x80100000002700460000000000001000
	/* C25 */
	.octa 0x4000000048040006ff80000000000402
	/* C29 */
	.octa 0x0
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x400000001007000700ffffffffffe001
initial_DDC_EL1_value:
	.octa 0xc0000000700210020000000000000001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x13, =esr_el1_dump_address
	.inst 0xc2c5b1b2 // cvtp c18, x13
	.inst 0xc2cd4252 // scvalue c18, c18, x13
	.inst 0x82600e4d // ldr x13, [c18, #0]
	cbnz x13, #28
	mrs x13, ESR_EL1
	.inst 0x82400e4d // str x13, [c18, #0]
	ldr x13, =0x40403414
	mrs x18, ELR_EL1
	sub x13, x13, x18
	cbnz x13, #8
