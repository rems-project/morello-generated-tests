...
finish:
	...
	.inst 0xc240002b // ldr c11, [x1, #0]
	.inst 0xc2cba461 // chkeq c3, c11
	b.ne comparison_fail
	.inst 0xc240042b // ldr c11, [x1, #1]
	.inst 0xc2cba541 // chkeq c10, c11
	b.ne comparison_fail
	.inst 0xc240082b // ldr c11, [x1, #2]
	.inst 0xc2cba5a1 // chkeq c13, c11
	b.ne comparison_fail
	.inst 0xc2400c2b // ldr c11, [x1, #3]
	.inst 0xc2cba5e1 // chkeq c15, c11
	b.ne comparison_fail
	.inst 0xc240102b // ldr c11, [x1, #4]
	.inst 0xc2cba621 // chkeq c17, c11
	b.ne comparison_fail
	.inst 0xc240142b // ldr c11, [x1, #5]
	.inst 0xc2cba6e1 // chkeq c23, c11
	b.ne comparison_fail
	.inst 0xc240182b // ldr c11, [x1, #6]
	.inst 0xc2cba701 // chkeq c24, c11
	b.ne comparison_fail
	.inst 0xc2401c2b // ldr c11, [x1, #7]
...
initial_cap_values:
	/* C3 */
	.octa 0x20008000800100060000000040400010
	/* C10 */
	.octa 0x800000002007000e000000004040bb88
	/* C17 */
	.octa 0x20008000d00100050000000040400019
	/* C23 */
	.octa 0x80004000200a29892100000000000006
	/* C24 */
...
final_cap_values:
	...
	.octa 0x20008000800100060000000040400010
	/* C10 */
	.octa 0x800000002007000e000000004040bb0c
	/* C13 */
	.octa 0x2000800050010005ffffffffe18a2000
	/* C15 */
...
initial_DDC_EL0_value:
	.octa 0xd8100000000100070080000000000001
initial_VBAR_EL1_value:
	.octa 0x20008000500084010000000040408800
final_PCC_value:
...
.section vector_table_el1, #alloc, #execinstr
	ldr x1, =esr_el1_dump_address
	.inst 0xc2c5b02b // cvtp c11, x1
	.inst 0xc2c1416b // scvalue c11, c11, x1
	.inst 0x82600d61 // ldr x1, [c11, #0]
	cbnz x1, #28
	mrs x1, ESR_EL1
	.inst 0x82400d61 // str x1, [c11, #0]
	ldr x1, =0x40400028
	mrs x11, ELR_EL1
	sub x1, x1, x11
	cbnz x1, #8
