...
.section data0, #alloc, #write
	.zero 96
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x03, 0x10, 0x00, 0x00, 0x00, 0x00
	.zero 2080
	.byte 0x6a, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 1888
.data
check_data0:
	.zero 32
...
.data
check_data4:
	.byte 0xd0, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x20
.data
check_data5:
...
initial_cap_values:
	...
	/* C29 */
	.octa 0x20000000000000000000000000000dd0
	/* C30 */
	.octa 0x1007
el1_vector_jump_cap:
	.dword 0x40400300
...
final_PCC_value:
	.octa 0x200080006000e0010000000040400028
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x200080006000e0010000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b36a // cvtp c10, x27
	.inst 0xc2db414a // scvalue c10, c10, x27
	.inst 0x82600d5b // ldr x27, [c10, #0]
	cbnz x27, #28
	mrs x27, ESR_EL1
	.inst 0x82400d5b // str x27, [c10, #0]
	ldr x27, =0x40400028
	mrs x10, ELR_EL1
	sub x27, x27, x10
	cbnz x27, #8
