...
.data
check_data0:
	.byte 0x01, 0x30, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00
.data
check_data1:
	.zero 16
.data
...
initial_cap_values:
	...
	.octa 0x0
	/* C28 */
	.octa 0x2000000000110
	/* C29 */
	.octa 0x40403001
	/* C30 */
	.octa 0xffdaaa4000000020
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x0
	/* C28 */
	.octa 0x2555c00000110
	/* C29 */
	.octa 0x40403001
	/* C30 */
	.octa 0xffdaaa4000000020
initial_DDC_EL0_value:
	.octa 0x80000000180b0007000000014f81a094
initial_DDC_EL1_value:
	.octa 0xc00000000021c0050000000000000001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x18, =esr_el1_dump_address
	.inst 0xc2c5b243 // cvtp c3, x18
	.inst 0xc2d24063 // scvalue c3, c3, x18
	.inst 0x82600c72 // ldr x18, [c3, #0]
	cbnz x18, #28
	mrs x18, ESR_EL1
	.inst 0x82400c72 // str x18, [c3, #0]
	ldr x18, =0x40400414
	mrs x3, ELR_EL1
	sub x18, x18, x3
	cbnz x18, #8
