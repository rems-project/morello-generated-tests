...
finish:
	...
	.inst 0xc240021c // ldr c28, [x16, #0]
	.inst 0xc2dca401 // chkeq c0, c28
	b.ne comparison_fail
	.inst 0xc240061c // ldr c28, [x16, #1]
	.inst 0xc2dca421 // chkeq c1, c28
	b.ne comparison_fail
	.inst 0xc2400a1c // ldr c28, [x16, #2]
...
initial_cap_values:
	...
	.octa 0x1000
	/* C30 */
	.octa 0xd00000000001000500000000000014a0
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x1000
	/* C30 */
	.octa 0xd0000000000100050000000000001940
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b21c // cvtp c28, x16
	.inst 0xc2d0439c // scvalue c28, c28, x16
	.inst 0x82600f90 // ldr x16, [c28, #0]
	cbnz x16, #28
	mrs x16, ESR_EL1
	.inst 0x82400f90 // str x16, [c28, #0]
	ldr x16, =0x40400028
	mrs x28, ELR_EL1
	sub x16, x16, x28
	cbnz x16, #8
