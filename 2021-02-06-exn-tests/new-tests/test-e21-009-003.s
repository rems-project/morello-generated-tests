...
finish:
	...
	b.ne comparison_fail
	.inst 0xc240204f // ldr c15, [x2, #8]
	.inst 0xc2cfa701 // chkeq c24, c15
	b.ne comparison_fail
	.inst 0xc240244f // ldr c15, [x2, #9]
	.inst 0xc2cfa781 // chkeq c28, c15
	b.ne comparison_fail
	.inst 0xc240284f // ldr c15, [x2, #10]
...
initial_cap_values:
	/* C1 */
	.octa 0x40000000601000010000000000002022
	/* C5 */
	.octa 0x1000
	/* C20 */
	.octa 0x11b0
	/* C24 */
	.octa 0x2000000000100010000000040401fd7
	/* C28 */
	.octa 0x40410007
el1_vector_jump_cap:
	.dword 0x40400300
