...
initial_cap_values:
	...
	.octa 0xf45
	/* C18 */
	.octa 0x20000000800100070000000040404000
	/* C30 */
	.octa 0x1000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_RSP_EL0_value:
	.octa 0x800000000000000010000000
...
.section vector_table_el1, #alloc, #execinstr
	ldr x13, =esr_el1_dump_address
	.inst 0xc2c5b1a3 // cvtp c3, x13
	.inst 0xc2cd4063 // scvalue c3, c3, x13
	.inst 0x82600c6d // ldr x13, [c3, #0]
	cbnz x13, #28
	mrs x13, ESR_EL1
	.inst 0x82400c6d // str x13, [c3, #0]
	ldr x13, =0x40400414
	mrs x3, ELR_EL1
	sub x13, x13, x3
	cbnz x13, #8
