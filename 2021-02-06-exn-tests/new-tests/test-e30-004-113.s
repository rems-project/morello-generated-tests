...
.section data0, #alloc, #write
	.byte 0x02, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 112
	.byte 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 368
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 3568
.data
check_data0:
	.byte 0x02, 0x00
...
initial_cap_values:
	...
	.octa 0x40410006
	/* C1 */
	.octa 0xc80000004201000200402fc400900002
	/* C4 */
	...
	.octa 0x171d
	/* C21 */
	.octa 0x80000000400000040000000040401017
	/* C29 */
	.octa 0x1000
	/* C30 */
	.octa 0x200080000801c0050000000040404001
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0xc000000040010a040000000000000001
initial_DDC_EL1_value:
	.octa 0xc00000002001400500911c00000de001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x10, =esr_el1_dump_address
	.inst 0xc2c5b154 // cvtp c20, x10
	.inst 0xc2ca4294 // scvalue c20, c20, x10
	.inst 0x82600e8a // ldr x10, [c20, #0]
	cbnz x10, #28
	mrs x10, ESR_EL1
	.inst 0x82400e8a // str x10, [c20, #0]
	ldr x10, =0x40400414
	mrs x20, ELR_EL1
	sub x10, x10, x20
	cbnz x10, #8
