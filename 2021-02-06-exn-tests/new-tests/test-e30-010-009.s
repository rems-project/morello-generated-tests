...
finish:
	...
	.inst 0xc24000fe // ldr c30, [x7, #0]
	.inst 0xc2dea401 // chkeq c0, c30
	b.ne comparison_fail
	.inst 0xc24004fe // ldr c30, [x7, #1]
	.inst 0xc2dea421 // chkeq c1, c30
	b.ne comparison_fail
	.inst 0xc24008fe // ldr c30, [x7, #2]
...
check_data6:
	...
	.byte 0xc0, 0x80, 0x13, 0xb8, 0x1d, 0xb1, 0x8e, 0xe2, 0xba, 0x2c, 0x8c, 0x38, 0xe0, 0x6b, 0xaf, 0x9b
	.byte 0x3d, 0x8c, 0x28, 0xe2, 0x01, 0x00, 0x00, 0xd4
.data
check_data7:
	.zero 16
...
initial_cap_values:
	...
	.octa 0x1000
	/* C1 */
	.octa 0x80000000000100050000000040407f58
	/* C5 */
	.octa 0x103b
	/* C6 */
	.octa 0x2008
	/* C8 */
	.octa 0x400000000001000500000000000010f5
	/* C9 */
	.octa 0x40000000100200060000000000000fe7
	/* C21 */
	.octa 0x1000
	/* C29 */
	.octa 0x0
...
initial_DDC_EL0_value:
	.octa 0xd0100000200000000000000000000001
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b0fe // cvtp c30, x7
	.inst 0xc2c743de // scvalue c30, c30, x7
	.inst 0x82600fc7 // ldr x7, [c30, #0]
	cbnz x7, #28
	mrs x7, ESR_EL1
	.inst 0x82400fc7 // str x7, [c30, #0]
	ldr x7, =0x40400028
	mrs x30, ELR_EL1
	sub x7, x7, x30
	cbnz x7, #8
