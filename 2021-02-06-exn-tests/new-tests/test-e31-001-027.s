...
initial_cap_values:
	/* C0 */
	.octa 0x40018001008000000001e001
	/* C1 */
	.octa 0xff00000000001810
	/* C22 */
	.octa 0x400000001007040f0000000000001100
	/* C29 */
	.octa 0x1000
	/* C30 */
	.octa 0x120070008400000000000
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x40018001008000000001e001
	/* C12 */
	.octa 0x400180010000000000000000
	/* C22 */
	.octa 0x400000001007040f0000000000001100
	/* C27 */
	.octa 0x1200700083ffffffff6a5
	/* C29 */
	.octa 0x1000
initial_SP_EL0_value:
	.octa 0x80000000000700070100000000000000
initial_DDC_EL1_value:
	.octa 0x400000000007100700ffffffffffe001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x8, =esr_el1_dump_address
	.inst 0xc2c5b110 // cvtp c16, x8
	.inst 0xc2c84210 // scvalue c16, c16, x8
	.inst 0x82600e08 // ldr x8, [c16, #0]
	cbnz x8, #28
	mrs x8, ESR_EL1
	.inst 0x82400e08 // str x8, [c16, #0]
	ldr x8, =0x40400414
	mrs x16, ELR_EL1
	sub x8, x8, x16
	cbnz x8, #8
