...
initial_cap_values:
	...
	.octa 0xf45
	/* C18 */
	.octa 0x20000000810100070000000040400021
	/* C30 */
	.octa 0x1000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0xc0000000400108000000000000000001
initial_DDC_EL1_value:
	.octa 0xc0000000000300070000000000000001
initial_VBAR_EL1_value:
	.octa 0x20008000480880010000000040408000
final_PCC_value:
	.octa 0x20008000480880010000000040408414
...
.section vector_table_el1, #alloc, #execinstr
	ldr x6, =esr_el1_dump_address
	.inst 0xc2c5b0cd // cvtp c13, x6
	.inst 0xc2c641ad // scvalue c13, c13, x6
	.inst 0x82600da6 // ldr x6, [c13, #0]
	cbnz x6, #28
	mrs x6, ESR_EL1
	.inst 0x82400da6 // str x6, [c13, #0]
	ldr x6, =0x40408414
	mrs x13, ELR_EL1
	sub x6, x6, x13
	cbnz x6, #8
