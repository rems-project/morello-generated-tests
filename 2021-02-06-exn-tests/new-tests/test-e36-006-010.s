...
initial_cap_values:
	...
	.octa 0x0
	/* C6 */
	.octa 0x40000000000100050000000000001c20
	/* C10 */
	.octa 0x0
	/* C22 */
	.octa 0x80000000000500070000000000001390
	/* C23 */
	.octa 0x80100000100140050000000000001000
	/* C25 */
	.octa 0x4000000040012002ff00000000001fc3
	/* C29 */
	.octa 0x0
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x400000005902159400ffffffffffe001
initial_DDC_EL1_value:
	.octa 0xc0000000700010000000000000000001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x2, =esr_el1_dump_address
	.inst 0xc2c5b04c // cvtp c12, x2
	.inst 0xc2c2418c // scvalue c12, c12, x2
	.inst 0x82600d82 // ldr x2, [c12, #0]
	cbnz x2, #28
	mrs x2, ESR_EL1
	.inst 0x82400d82 // str x2, [c12, #0]
	ldr x2, =0x40404c14
	mrs x12, ELR_EL1
	sub x2, x2, x12
	cbnz x2, #8
