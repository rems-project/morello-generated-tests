...
.data
check_data0:
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x20, 0x81, 0x00
.data
check_data1:
	.byte 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x10
.data
check_data2:
	.zero 16
.data
...
initial_cap_values:
	/* C3 */
	.octa 0x81200000000000
	/* C5 */
	.octa 0xc0000000000702060000000000001000
	/* C6 */
	.octa 0x900000002007011dffffffffffffb600
	/* C8 */
	.octa 0x20000
	/* C10 */
	.octa 0x10000000
	/* C12 */
	.octa 0x20000000c20144240000000040408001
	/* C15 */
	.octa 0xffffffffffffff7c
	/* C17 */
	.octa 0x8000000000060007ff8000000000001d
	/* C30 */
	.octa 0x3
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x10000000
	/* C12 */
	.octa 0x2000800060020000190000004040000d
	/* C15 */
	.octa 0xffffffffffffff7c
	/* C17 */
	.octa 0x8000000000060007ff8000000000001d
...
initial_SP_EL1_value:
	.octa 0x4000000050c000020000000000000f80
initial_DDC_EL0_value:
	.octa 0xc00000001fc708060000000000001055
initial_VBAR_EL1_value:
	.octa 0x200080004c00104d0000000040404001
final_SP_EL1_value:
	.octa 0x4000000050c000020000000000000f80
final_PCC_value:
	.octa 0x200080004c00104d0000000040404414
...
.section vector_table_el1, #alloc, #execinstr
	ldr x22, =esr_el1_dump_address
	.inst 0xc2c5b2d2 // cvtp c18, x22
	.inst 0xc2d64252 // scvalue c18, c18, x22
	.inst 0x82600e56 // ldr x22, [c18, #0]
	cbnz x22, #28
	mrs x22, ESR_EL1
	.inst 0x82400e56 // str x22, [c18, #0]
	ldr x22, =0x40404414
	mrs x18, ELR_EL1
	sub x22, x22, x18
	cbnz x22, #8
