...
tag_init_end:
	...
	ldr x6, =0x200
	msr CPTR_EL3, x6
	ldr x6, =initial_RDDC_EL0_value
	.inst 0xc24000c6 // ldr c6, [x6, #0]
	.inst 0xc28b4326 // msr RDDC_EL0, c6
	ldr x6, =0x30d5d99f
	msr SCTLR_EL1, x6
	ldr x6, =0xc0000
	msr CPACR_EL1, x6
...
.data
check_data1:
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x10, 0x00, 0x02, 0x04, 0x08, 0x00, 0x00, 0x00, 0x40, 0x01, 0x00
.data
check_data2:
...
initial_cap_values:
	...
	/* C12 */
	.octa 0x20000000800100070000000040402000
	/* C15 */
	.octa 0x14000000008040200100000000000
	/* C21 */
	.octa 0x0
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x800000005400000000ffffffffffe001
initial_DDC_EL1_value:
	.octa 0xd81000005ff000040000000000006001
