...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402988 // ldr c8, [x12, #10]
	.inst 0xc2c8a781 // chkeq c28, c8
	b.ne comparison_fail
	.inst 0xc2402d88 // ldr c8, [x12, #11]
	.inst 0xc2c8a7a1 // chkeq c29, c8
	b.ne comparison_fail
	.inst 0xc2403188 // ldr c8, [x12, #12]
...
initial_cap_values:
	/* C0 */
	.octa 0x800000004004c001ffffe0200000c000
	/* C1 */
	.octa 0x19e4
	/* C4 */
	.octa 0x0
	/* C5 */
	.octa 0x400000003fff10070000000000001004
	/* C10 */
	.octa 0xc0000000400000800000000000001000
	/* C13 */
	.octa 0x0
	/* C21 */
	.octa 0x1000
...
initial_DDC_EL1_value:
	.octa 0xc00000000807000000ffffffffffe801
...
.section vector_table_el1, #alloc, #execinstr
	ldr x12, =esr_el1_dump_address
	.inst 0xc2c5b188 // cvtp c8, x12
	.inst 0xc2cc4108 // scvalue c8, c8, x12
	.inst 0x82600d0c // ldr x12, [c8, #0]
	cbnz x12, #28
	mrs x12, ESR_EL1
	.inst 0x82400d0c // str x12, [c8, #0]
	ldr x12, =0x40400c14
	mrs x8, ELR_EL1
	sub x12, x12, x8
	cbnz x12, #8
