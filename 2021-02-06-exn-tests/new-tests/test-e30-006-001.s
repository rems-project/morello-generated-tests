...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2400a81 // ldr c1, [x20, #2]
	.inst 0xc2c1a521 // chkeq c9, c1
	b.ne comparison_fail
	.inst 0xc2400e81 // ldr c1, [x20, #3]
	.inst 0xc2c1a5c1 // chkeq c14, c1
	b.ne comparison_fail
	.inst 0xc2401281 // ldr c1, [x20, #4]
	.inst 0xc2c1a641 // chkeq c18, c1
	b.ne comparison_fail
	.inst 0xc2401681 // ldr c1, [x20, #5]
	.inst 0xc2c1a761 // chkeq c27, c1
	b.ne comparison_fail
	.inst 0xc2401a81 // ldr c1, [x20, #6]
	.inst 0xc2c1a7a1 // chkeq c29, c1
	b.ne comparison_fail
	.inst 0xc2401e81 // ldr c1, [x20, #7]
...
.section data0, #alloc, #write
	...
	.zero 2032
	.byte 0xf0, 0x7f, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0x9c, 0x5f, 0x87, 0x7f, 0x00, 0x00, 0x00, 0x80
	.zero 2032
.data
check_data0:
...
initial_cap_values:
	...
	.octa 0x1000
	/* C18 */
	.octa 0x80100000000100050000000000001200
	/* C27 */
	.octa 0x1800
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0xd01000000003000700000530f7fc0001
initial_VBAR_EL1_value:
	.octa 0x200080007000a41d000000004040a800
final_SP_EL0_value:
	.octa 0x2
final_PCC_value:
	.octa 0x200080007000a41d000000004040ac14
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x200080000b9100070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x20, =esr_el1_dump_address
	.inst 0xc2c5b281 // cvtp c1, x20
	.inst 0xc2d44021 // scvalue c1, c1, x20
	.inst 0x82600c34 // ldr x20, [c1, #0]
	cbnz x20, #28
	mrs x20, ESR_EL1
	.inst 0x82400c34 // str x20, [c1, #0]
	ldr x20, =0x4040ac14
	mrs x1, ELR_EL1
	sub x20, x20, x1
	cbnz x20, #8
