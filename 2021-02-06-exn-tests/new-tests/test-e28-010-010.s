...
finish:
	...
	.inst 0xc240000d // ldr c13, [x0, #0]
	.inst 0xc2cda421 // chkeq c1, c13
	b.ne comparison_fail
	.inst 0xc240040d // ldr c13, [x0, #1]
	.inst 0xc2cda4a1 // chkeq c5, c13
	b.ne comparison_fail
	.inst 0xc240080d // ldr c13, [x0, #2]
	.inst 0xc2cda581 // chkeq c12, c13
	b.ne comparison_fail
	.inst 0xc2400c0d // ldr c13, [x0, #3]
	.inst 0xc2cda5c1 // chkeq c14, c13
	b.ne comparison_fail
	.inst 0xc240100d // ldr c13, [x0, #4]
	.inst 0xc2cda641 // chkeq c18, c13
	b.ne comparison_fail
	.inst 0xc240140d // ldr c13, [x0, #5]
...
initial_cap_values:
	...
	.octa 0xf45
	/* C18 */
	.octa 0x20000000800100050000000040400200
	/* C30 */
	.octa 0x1000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_RSP_EL0_value:
	.octa 0x80000000000620120080000000000000
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c041ad // scvalue c13, c13, x0
	.inst 0x82600da0 // ldr x0, [c13, #0]
	cbnz x0, #28
	mrs x0, ESR_EL1
	.inst 0x82400da0 // str x0, [c13, #0]
	ldr x0, =0x40405414
	mrs x13, ELR_EL1
	sub x0, x0, x13
	cbnz x0, #8
