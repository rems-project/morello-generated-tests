...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2403662 // ldr c2, [x19, #13]
	.inst 0xc2c2a7a1 // chkeq c29, c2
	b.ne comparison_fail
	.inst 0xc2403a62 // ldr c2, [x19, #14]
...
check_data6:
	...
	.byte 0xbf, 0x23, 0x3f, 0x78, 0x7f, 0x30, 0x65, 0x38, 0xc9, 0x1f, 0xfb, 0x8a, 0x49, 0x7b, 0x14, 0x78
	.byte 0x01, 0xfd, 0xdf, 0xc8, 0x01, 0x00, 0x00, 0xd4
.data
check_data7:
	.zero 8
.data
...
initial_cap_values:
	...
	.octa 0x0
	/* C12 */
	.octa 0x80000000000100050000000000001406
	/* C14 */
	.octa 0x1200
	/* C26 */
	.octa 0x20b5
...
initial_DDC_EL0_value:
	.octa 0xc0000000001100070000000000000001
