...
.data
check_data0:
	.byte 0x00, 0x00, 0x08, 0x40, 0x00, 0x80, 0x08, 0x40
.data
check_data1:
	.zero 2
.data
check_data2:
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0xc3, 0x00, 0xc0
.data
check_data3:
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00
.data
...
initial_cap_values:
	...
	.octa 0x40088000
	/* C12 */
	.octa 0x200080008007a007000000004040a000
	/* C15 */
	.octa 0x103c
	/* C17 */
	.octa 0x42ffffffff54
...
final_cap_values:
	...
	.octa 0x40088000
	/* C12 */
	.octa 0x200080001007a007190000004040000d
	/* C15 */
	.octa 0x103c
	/* C17 */
	.octa 0x42ffffffff54
...
initial_DDC_EL0_value:
	.octa 0xc00000000003000700fff7ff7fffe000
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x200080001007a0070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x1, =esr_el1_dump_address
	.inst 0xc2c5b039 // cvtp c25, x1
	.inst 0xc2c14339 // scvalue c25, c25, x1
	.inst 0x82600f21 // ldr x1, [c25, #0]
	cbnz x1, #28
	mrs x1, ESR_EL1
	.inst 0x82400f21 // str x1, [c25, #0]
	ldr x1, =0x40400414
	mrs x25, ELR_EL1
	sub x1, x1, x25
	cbnz x1, #8
