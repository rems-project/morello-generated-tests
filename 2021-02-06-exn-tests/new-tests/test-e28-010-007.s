...
tag_init_end:
	...
	ldr x4, =0x200
	msr CPTR_EL3, x4
	ldr x4, =initial_RSP_EL0_value
	.inst 0xc2400084 // ldr c4, [x4, #0]
	.inst 0xc28f4164 // msr RSP_EL0, c4
	ldr x4, =0x30d5d99f
	msr SCTLR_EL1, x4
	ldr x4, =0x3c0000
	msr CPACR_EL1, x4
...
initial_cap_values:
	...
	/* C18 */
	.octa 0x20000000a00720070000000040404000
	/* C30 */
	.octa 0xc00000000001000500000000000015be
el1_vector_jump_cap:
	.dword 0x40400300
