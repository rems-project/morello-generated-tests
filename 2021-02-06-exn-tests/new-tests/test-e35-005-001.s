...
initial_cap_values:
	...
	.octa 0x1000
	/* C17 */
	.octa 0x80010007ffffffffff6b6098
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0xc0000000405000580000000000000000
initial_DDC_EL1_value:
	.octa 0xc0000000002140050080000000800001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x3, =esr_el1_dump_address
	.inst 0xc2c5b074 // cvtp c20, x3
	.inst 0xc2c34294 // scvalue c20, c20, x3
	.inst 0x82600e83 // ldr x3, [c20, #0]
	cbnz x3, #28
	mrs x3, ESR_EL1
	.inst 0x82400e83 // str x3, [c20, #0]
	ldr x3, =0x40402414
	mrs x20, ELR_EL1
	sub x3, x3, x20
	cbnz x3, #8
