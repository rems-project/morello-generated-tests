...
.section data0, #alloc, #write
	.zero 256
	.byte 0x00, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01
	.zero 1760
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b316 // cvtp c22, x24
	.inst 0xc2d842d6 // scvalue c22, c22, x24
	.inst 0x82600ed8 // ldr x24, [c22, #0]
	cbnz x24, #28
	mrs x24, ESR_EL1
	.inst 0x82400ed8 // str x24, [c22, #0]
	ldr x24, =0x40400028
	mrs x22, ELR_EL1
	sub x24, x24, x22
	cbnz x24, #8
