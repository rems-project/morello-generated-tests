...
initial_cap_values:
	...
	.octa 0x364
	/* C1 */
	.octa 0x200080008007208f0000000040404000
	/* C7 */
...
final_cap_values:
	...
	.octa 0x1000
	/* C30 */
	.octa 0xffffffff80000000
initial_SP_EL1_value:
	.octa 0xc0000000000500030000000000001010
initial_DDC_EL0_value:
	.octa 0x80000000600100000000000000000001
initial_DDC_EL1_value:
	.octa 0x400000005802100000ffffffffffe001
initial_VBAR_EL1_value:
	.octa 0x200080004200c41d000000004040e001
final_SP_EL1_value:
	.octa 0xc0000000000500030000000000001010
final_PCC_value:
	.octa 0x200080004200c41d000000004040e414
...
.section vector_table_el1, #alloc, #execinstr
	ldr x10, =esr_el1_dump_address
	.inst 0xc2c5b145 // cvtp c5, x10
	.inst 0xc2ca40a5 // scvalue c5, c5, x10
	.inst 0x82600caa // ldr x10, [c5, #0]
	cbnz x10, #28
	mrs x10, ESR_EL1
	.inst 0x82400caa // str x10, [c5, #0]
	ldr x10, =0x4040e414
	mrs x5, ELR_EL1
	sub x10, x10, x5
	cbnz x10, #8
