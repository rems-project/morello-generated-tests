...
initial_cap_values:
	...
	.octa 0x1620
	/* C5 */
	.octa 0x804280460080800000000001
	/* C10 */
	.octa 0x1
	/* C16 */
	.octa 0x40400028
...
final_PCC_value:
	.octa 0x20008000001140050000000040400038
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b163 // cvtp c3, x11
	.inst 0xc2cb4063 // scvalue c3, c3, x11
	.inst 0x82600c6b // ldr x11, [c3, #0]
	cbnz x11, #28
	mrs x11, ESR_EL1
	.inst 0x82400c6b // str x11, [c3, #0]
	ldr x11, =0x40400038
	mrs x3, ELR_EL1
	sub x11, x11, x3
	cbnz x11, #8
