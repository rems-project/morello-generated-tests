...
finish:
	...
	.inst 0xc240039e // ldr c30, [x28, #0]
	.inst 0xc2dea401 // chkeq c0, c30
	b.ne comparison_fail
	.inst 0xc240079e // ldr c30, [x28, #1]
	.inst 0xc2dea421 // chkeq c1, c30
	b.ne comparison_fail
	.inst 0xc2400b9e // ldr c30, [x28, #2]
...
initial_cap_values:
	...
	.octa 0x1000
	/* C1 */
	.octa 0x8051001e0000000000000000
	/* C4 */
	.octa 0x0
	/* C6 */
	.octa 0x4000000000000000000000000000100c
	/* C10 */
	.octa 0x0
	/* C22 */
...
initial_DDC_EL1_value:
	.octa 0xc0000000040710070000000000006001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x28, =esr_el1_dump_address
	.inst 0xc2c5b39e // cvtp c30, x28
	.inst 0xc2dc43de // scvalue c30, c30, x28
	.inst 0x82600fdc // ldr x28, [c30, #0]
	cbnz x28, #28
	mrs x28, ESR_EL1
	.inst 0x82400fdc // str x28, [c30, #0]
	ldr x28, =0x40400414
	mrs x30, ELR_EL1
	sub x28, x28, x30
	cbnz x28, #8
