...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2400a01 // ldr c1, [x16, #2]
	.inst 0xc2c1a4c1 // chkeq c6, c1
	b.ne comparison_fail
	.inst 0xc2400e01 // ldr c1, [x16, #3]
	.inst 0xc2c1a501 // chkeq c8, c1
	b.ne comparison_fail
	.inst 0xc2401201 // ldr c1, [x16, #4]
	.inst 0xc2c1a541 // chkeq c10, c1
	b.ne comparison_fail
	.inst 0xc2401601 // ldr c1, [x16, #5]
	.inst 0xc2c1a581 // chkeq c12, c1
	b.ne comparison_fail
	.inst 0xc2401a01 // ldr c1, [x16, #6]
	.inst 0xc2c1a5e1 // chkeq c15, c1
	b.ne comparison_fail
	.inst 0xc2401e01 // ldr c1, [x16, #7]
	.inst 0xc2c1a621 // chkeq c17, c1
	b.ne comparison_fail
	.inst 0xc2402201 // ldr c1, [x16, #8]
...
initial_cap_values:
	...
	.octa 0x0
	/* C12 */
	.octa 0x20008000c000000c0000000040400010
	/* C15 */
	.octa 0x1344
	/* C17 */
	.octa 0xffffffffffffff61
	/* C30 */
	.octa 0x1401
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x0
	/* C12 */
	.octa 0x2000800020362007190000004040000d
	/* C15 */
	.octa 0x1344
	/* C17 */
	.octa 0xffffffffffffff61
...
initial_DDC_EL1_value:
	.octa 0xd0100000000000000000000000000001
initial_VBAR_EL1_value:
	.octa 0x20008000400000140000000040400000
final_SP_EL1_value:
	.octa 0x1f00
final_PCC_value:
	.octa 0x20008000400000140000000040400414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000203620070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x16, =esr_el1_dump_address
	.inst 0xc2c5b201 // cvtp c1, x16
	.inst 0xc2d04021 // scvalue c1, c1, x16
	.inst 0x82600c30 // ldr x16, [c1, #0]
	cbnz x16, #28
	mrs x16, ESR_EL1
	.inst 0x82400c30 // str x16, [c1, #0]
	ldr x16, =0x40400414
	mrs x1, ELR_EL1
	sub x16, x16, x1
	cbnz x16, #8
