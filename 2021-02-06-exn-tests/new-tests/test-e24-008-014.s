...
.section data0, #alloc, #write
	.byte 0x03, 0x10, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
...
initial_cap_values:
	/* C13 */
	.octa 0x40000000400100800000000000002042
	/* C25 */
	.octa 0x1002
	/* C29 */
	.octa 0x1000
...
final_cap_values:
	...
	.octa 0x0
	/* C1 */
	.octa 0x20008000088140050000000000001000
	/* C13 */
	.octa 0x40000000400100800000000000002042
	/* C21 */
	.octa 0x0
...
initial_DDC_EL0_value:
	.octa 0xc0100000000940050000000000000003
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_PCC_value:
	.octa 0x20008000088140050000000040400028
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000088140050000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b238 // cvtp c24, x17
	.inst 0xc2d14318 // scvalue c24, c24, x17
	.inst 0x82600f11 // ldr x17, [c24, #0]
	cbnz x17, #28
	mrs x17, ESR_EL1
	.inst 0x82400f11 // str x17, [c24, #0]
	ldr x17, =0x40400028
	mrs x24, ELR_EL1
	sub x17, x17, x24
	cbnz x17, #8
