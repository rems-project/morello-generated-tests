...
.section data0, #alloc, #write
	...
	.zero 3872
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xcd, 0x00
.data
check_data0:
	.zero 2
.data
...
initial_cap_values:
	...
	/* C18 */
	.octa 0x20008000800100070000000040400200
	/* C30 */
...
.section vector_table_el1, #alloc, #execinstr
	ldr x24, =esr_el1_dump_address
	.inst 0xc2c5b311 // cvtp c17, x24
	.inst 0xc2d84231 // scvalue c17, c17, x24
	.inst 0x82600e38 // ldr x24, [c17, #0]
	cbnz x24, #28
	mrs x24, ESR_EL1
	.inst 0x82400e38 // str x24, [c17, #0]
	ldr x24, =0x40401414
	mrs x17, ELR_EL1
	sub x24, x24, x17
	cbnz x24, #8
