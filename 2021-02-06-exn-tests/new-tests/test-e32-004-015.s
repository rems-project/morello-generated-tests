...
initial_cap_values:
	/* C3 */
	.octa 0x200080009007000f0000000040400100
	/* C10 */
	.octa 0x4040107c
	/* C17 */
	.octa 0x20008000d00200230000000040400200
	/* C23 */
	.octa 0x800040001001900b46010000000000c7
	/* C24 */
...
initial_DDC_EL0_value:
	.octa 0xd8100000580100000000000000000001
initial_DDC_EL1_value:
	.octa 0x800000000a06a004000000003c000001
initial_VBAR_EL1_value:
	.octa 0x2000800040008401000000004040a000
final_PCC_value:
	.octa 0x20008000500200230000000040400210
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x200080003b7b00070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x16, =esr_el1_dump_address
	.inst 0xc2c5b21b // cvtp c27, x16
	.inst 0xc2d0437b // scvalue c27, c27, x16
	.inst 0x82600f70 // ldr x16, [c27, #0]
	cbnz x16, #28
	mrs x16, ESR_EL1
	.inst 0x82400f70 // str x16, [c27, #0]
	ldr x16, =0x40400210
	mrs x27, ELR_EL1
	sub x16, x16, x27
	cbnz x16, #8
