...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2403359 // ldr c25, [x26, #12]
...
initial_cap_values:
	/* C0 */
	.octa 0xcc000000000205fb0080000000000004
	/* C1 */
	.octa 0x4040fffc
	/* C4 */
	.octa 0x0
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x200080001ffb00040000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x26, =esr_el1_dump_address
	.inst 0xc2c5b359 // cvtp c25, x26
	.inst 0xc2da4339 // scvalue c25, c25, x26
	.inst 0x82600f3a // ldr x26, [c25, #0]
	cbnz x26, #28
	mrs x26, ESR_EL1
	.inst 0x82400f3a // str x26, [c25, #0]
	ldr x26, =0x40404414
	mrs x25, ELR_EL1
	sub x26, x26, x25
	cbnz x26, #8
