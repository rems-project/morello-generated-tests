...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2400961 // ldr c1, [x11, #2]
	.inst 0xc2c1a521 // chkeq c9, c1
	b.ne comparison_fail
	.inst 0xc2400d61 // ldr c1, [x11, #3]
	.inst 0xc2c1a5c1 // chkeq c14, c1
	b.ne comparison_fail
	.inst 0xc2401161 // ldr c1, [x11, #4]
	.inst 0xc2c1a641 // chkeq c18, c1
	b.ne comparison_fail
	.inst 0xc2401561 // ldr c1, [x11, #5]
	.inst 0xc2c1a761 // chkeq c27, c1
	b.ne comparison_fail
	.inst 0xc2401961 // ldr c1, [x11, #6]
	.inst 0xc2c1a7a1 // chkeq c29, c1
	b.ne comparison_fail
	.inst 0xc2401d61 // ldr c1, [x11, #7]
...
initial_cap_values:
	...
	.octa 0x1000
	/* C18 */
	.octa 0x90000000020140050000000000001020
	/* C27 */
	.octa 0xffc
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0xd0100000600600040000000000000000
initial_VBAR_EL1_value:
	.octa 0x200080004480209d0000000040404000
final_SP_EL0_value:
	.octa 0x0
final_PCC_value:
	.octa 0x200080004480209d0000000040404414
...
.section vector_table_el1, #alloc, #execinstr
	ldr x11, =esr_el1_dump_address
	.inst 0xc2c5b161 // cvtp c1, x11
	.inst 0xc2cb4021 // scvalue c1, c1, x11
	.inst 0x82600c2b // ldr x11, [c1, #0]
	cbnz x11, #28
	mrs x11, ESR_EL1
	.inst 0x82400c2b // str x11, [c1, #0]
	ldr x11, =0x40404414
	mrs x1, ELR_EL1
	sub x11, x11, x1
	cbnz x11, #8
