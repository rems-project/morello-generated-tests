...
finish:
	...
	b.ne comparison_fail
	.inst 0xc240366d // ldr c13, [x19, #13]
	.inst 0xc2cda7a1 // chkeq c29, c13
	b.ne comparison_fail
	.inst 0xc2403a6d // ldr c13, [x19, #14]
...
.data
check_data0:
	.byte 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00
.data
check_data1:
...
initial_cap_values:
	...
	.octa 0xb9000000
	/* C12 */
	.octa 0x8000000040010009000000000000100e
	/* C14 */
	.octa 0x1000
	/* C26 */
	.octa 0x10c5
...
initial_DDC_EL1_value:
	.octa 0xc0000000480108040000000000000001
