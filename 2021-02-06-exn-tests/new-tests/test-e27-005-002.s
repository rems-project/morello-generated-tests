...
initial_cap_values:
	...
	.octa 0x0
	/* C1 */
	.octa 0x400200010080000000000001
	/* C4 */
	.octa 0x4040fffe
	/* C6 */
	.octa 0xee000000000002
	/* C9 */
	.octa 0x17d0
	/* C26 */
...
initial_DDC_EL0_value:
	.octa 0xc00000003842000600c0000000000001
initial_DDC_EL1_value:
	.octa 0xc0000000000100070000000000000001
initial_VBAR_EL1_value:
	.octa 0x20008000520004000000000040400000
final_SP_EL0_value:
	.octa 0x1ff0
final_PCC_value:
	.octa 0x20008000520004000000000040400414
...
.section vector_table_el1, #alloc, #execinstr
	ldr x8, =esr_el1_dump_address
	.inst 0xc2c5b107 // cvtp c7, x8
	.inst 0xc2c840e7 // scvalue c7, c7, x8
	.inst 0x82600ce8 // ldr x8, [c7, #0]
	cbnz x8, #28
	mrs x8, ESR_EL1
	.inst 0x82400ce8 // str x8, [c7, #0]
	ldr x8, =0x40400414
	mrs x7, ELR_EL1
	sub x8, x8, x7
	cbnz x8, #8
