...
.data
check_data2:
	.byte 0x00, 0x00, 0xd0, 0x00, 0x00, 0x00, 0x00, 0x00
.data
check_data3:
	.zero 1
.data
...
initial_cap_values:
	...
	.octa 0x10c2
	/* C1 */
	.octa 0x600120000000000000000001
	/* C4 */
	.octa 0x0
	/* C6 */
	...
	.octa 0x0
	/* C22 */
	.octa 0x80000000000300070000000000001808
	/* C23 */
	.octa 0x801000000007000f0000000000001040
	/* C25 */
	.octa 0x0
	/* C29 */
	.octa 0xd00000
...
final_cap_values:
	...
	.octa 0x0
	/* C29 */
	.octa 0x600120000000000000000000
initial_DDC_EL0_value:
	.octa 0x40000000400400120000000000006001
initial_DDC_EL1_value:
	.octa 0xc0000000080704050000000000000001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x27, =esr_el1_dump_address
	.inst 0xc2c5b36d // cvtp c13, x27
	.inst 0xc2db41ad // scvalue c13, c13, x27
	.inst 0x82600dbb // ldr x27, [c13, #0]
	cbnz x27, #28
	mrs x27, ESR_EL1
	.inst 0x82400dbb // str x27, [c13, #0]
	ldr x27, =0x40400414
	mrs x13, ELR_EL1
	sub x27, x27, x13
	cbnz x27, #8
