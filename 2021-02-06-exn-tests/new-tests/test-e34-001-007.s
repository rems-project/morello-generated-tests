...
.section data0, #alloc, #write
	...
	.zero 2032
	.byte 0x00, 0xfb, 0xfb, 0xff, 0x8a, 0xff, 0xfb, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 2032
.data
check_data0:
...
.data
check_data2:
	.byte 0x00, 0xfb, 0xfb, 0xff, 0x8a, 0xff, 0xfb, 0xff
.data
check_data3:
	.zero 16
.data
...
initial_cap_values:
	/* C0 */
	.octa 0x10000000000000000000000000000000
	/* C1 */
	.octa 0x80000000400200040000000000001000
	/* C3 */
	.octa 0x1fe0
	/* C5 */
	.octa 0x800000000003000700000000403ffa0c
	/* C7 */
	.octa 0x800000000001000700000000000010b3
	/* C13 */
	.octa 0x7fffffffbffdfffbffffffffffffefff
	/* C27 */
...
initial_DDC_EL0_value:
	.octa 0x200030000000000000000
initial_DDC_EL1_value:
	.octa 0xc81000007100000100ffffffffffe001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x9, =esr_el1_dump_address
	.inst 0xc2c5b136 // cvtp c22, x9
	.inst 0xc2c942d6 // scvalue c22, c22, x9
	.inst 0x82600ec9 // ldr x9, [c22, #0]
	cbnz x9, #28
	mrs x9, ESR_EL1
	.inst 0x82400ec9 // str x9, [c22, #0]
	ldr x9, =0x40400414
	mrs x22, ELR_EL1
	sub x9, x9, x22
	cbnz x9, #8
