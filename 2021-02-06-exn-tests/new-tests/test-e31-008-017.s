...
.data
check_data0:
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
.data
check_data1:
	.zero 16
.data
...
initial_cap_values:
	...
	.octa 0x0
	/* C12 */
	.octa 0x20000000d001c000000000004040c000
	/* C15 */
	.octa 0x200000020000000000
	/* C21 */
	.octa 0x0
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL1_value:
	.octa 0xd0100000400010040000000000006001
initial_VBAR_EL1_value:
	.octa 0x200080006800200d0000000040402000
final_SP_EL1_value:
	.octa 0x400
final_PCC_value:
	.octa 0x200080006800200d0000000040402414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x200080004010c0120000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x14, =esr_el1_dump_address
	.inst 0xc2c5b1da // cvtp c26, x14
	.inst 0xc2ce435a // scvalue c26, c26, x14
	.inst 0x82600f4e // ldr x14, [c26, #0]
	cbnz x14, #28
	mrs x14, ESR_EL1
	.inst 0x82400f4e // str x14, [c26, #0]
	ldr x14, =0x40402414
	mrs x26, ELR_EL1
	sub x14, x14, x26
	cbnz x14, #8
