...
.section data0, #alloc, #write
	.byte 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x84, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
...
initial_cap_values:
	...
	/* C7 */
	.octa 0xc0000000000180060000000000001000
	/* C15 */
	.octa 0x0
	/* C18 */
	.octa 0x400000000000000000001258
	/* C25 */
	.octa 0xc0000000400000010000000000001000
	/* C29 */
	.octa 0xff7bfffffffffff0
	/* C30 */
	.octa 0xffff
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	/* C0 */
	.octa 0x525812580000000000001258
	/* C1 */
	.octa 0x84000000000010
	/* C7 */
	.octa 0xc0000000000180060000000000001000
	/* C15 */
	.octa 0x0
	...
	.octa 0xc0000000400000010000000000001000
	/* C28 */
	.octa 0xffffffffbfbff7fc
	/* C29 */
	.octa 0xff7bfffffffffff0
	/* C30 */
	.octa 0x0
initial_SP_EL0_value:
	.octa 0x400000000007000600000000000018c0
initial_DDC_EL0_value:
	.octa 0x4000000040010008007fffffffffe001
initial_DDC_EL1_value:
	.octa 0x800120070040000040000000
initial_VBAR_EL1_value:
	.octa 0x200080005b0008040000000040401001
final_SP_EL0_value:
	.octa 0x400000000007000600000000000018c0
final_PCC_value:
	.octa 0x200080005b0008040000000040401a64
...
.section vector_table_el1, #alloc, #execinstr
	ldr x9, =esr_el1_dump_address
	.inst 0xc2c5b131 // cvtp c17, x9
	.inst 0xc2c94231 // scvalue c17, c17, x9
	.inst 0x82600e29 // ldr x9, [c17, #0]
	cbnz x9, #28
	mrs x9, ESR_EL1
	.inst 0x82400e29 // str x9, [c17, #0]
	ldr x9, =0x40401a64
	mrs x17, ELR_EL1
	sub x9, x9, x17
	cbnz x9, #8
