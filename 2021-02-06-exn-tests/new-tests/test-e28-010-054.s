...
.data
check_data0:
	.byte 0x01, 0x00, 0x02, 0x00, 0x00, 0x08, 0x00, 0x00
.data
check_data1:
	.zero 2
.data
...
initial_cap_values:
	...
	/* C18 */
	.octa 0x20008000800100070000000040400080
	/* C30 */
...
initial_SP_EL0_value:
	.octa 0x8000000000068008000001ffc0000000
initial_DDC_EL0_value:
	.octa 0xc0000000000080080000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080005000041e0000000040400801
final_SP_EL0_value:
	.octa 0x8000000000068008000001ffc0000000
final_PCC_value:
...
.section vector_table_el1, #alloc, #execinstr
	ldr x16, =esr_el1_dump_address
	.inst 0xc2c5b21d // cvtp c29, x16
	.inst 0xc2d043bd // scvalue c29, c29, x16
	.inst 0x82600fb0 // ldr x16, [c29, #0]
	cbnz x16, #28
	mrs x16, ESR_EL1
	.inst 0x82400fb0 // str x16, [c29, #0]
	ldr x16, =0x40400c14
	mrs x29, ELR_EL1
	sub x16, x16, x29
	cbnz x16, #8
