...
tag_init_end:
	...
	.inst 0xc240180f // ldr c15, [x0, #6]
	.inst 0xc2401c11 // ldr c17, [x0, #7]
...
.data
check_data2:
	.byte 0x00, 0x00, 0x40, 0x00, 0x00, 0x00, 0x40, 0x04
.data
check_data3:
	.zero 2
.data
...
initial_cap_values:
	...
	.octa 0x4400000
	/* C12 */
	.octa 0x20008000f00200800000000040401000
	/* C15 */
	.octa 0x1008
	/* C17 */
	.octa 0x3e
...
final_cap_values:
	...
	.octa 0x4400000
	/* C12 */
	.octa 0x2000800050020000190000004040000d
	/* C15 */
	.octa 0x1008
	/* C17 */
	.octa 0x3e
...
initial_DDC_EL0_value:
	.octa 0xc0000000400300040000000000000001
