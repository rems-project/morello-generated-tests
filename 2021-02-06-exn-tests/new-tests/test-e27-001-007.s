...
.section data0, #alloc, #write
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
...
initial_cap_values:
	/* C1 */
	.octa 0xc0000000400209100000000000001000
	/* C7 */
	.octa 0xc0000000000100050000000000001004
	/* C15 */
	.octa 0x1
	/* C18 */
	.octa 0x800000020000000040400ffc
	/* C25 */
	.octa 0xc00000006000020c0000000000001004
	/* C29 */
	.octa 0x7b80000000000000
	/* C30 */
	.octa 0xffff
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	/* C0 */
	.octa 0xcffc0ffc0000000040400ffc
	/* C1 */
	.octa 0x480000000000000
	/* C7 */
	.octa 0xc0000000000100050000000000001004
	/* C15 */
	.octa 0x1
...
initial_DDC_EL0_value:
	.octa 0x7fc8600ffffffffff8001
initial_DDC_EL1_value:
	.octa 0x36007007fffffe0000000
initial_VBAR_EL1_value:
	.octa 0x2000800048000e6d0000000040404001
final_SP_EL0_value:
	.octa 0x40000000000100050000000000001000
final_PCC_value:
	.octa 0x2000800048000e6d0000000040401004
...
.section vector_table_el1, #alloc, #execinstr
	ldr x17, =esr_el1_dump_address
	.inst 0xc2c5b229 // cvtp c9, x17
	.inst 0xc2d14129 // scvalue c9, c9, x17
	.inst 0x82600d31 // ldr x17, [c9, #0]
	cbnz x17, #28
	mrs x17, ESR_EL1
	.inst 0x82400d31 // str x17, [c9, #0]
	ldr x17, =0x40401004
	mrs x9, ELR_EL1
	sub x17, x17, x9
	cbnz x17, #8
