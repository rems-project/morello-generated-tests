...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24022c2 // ldr c2, [x22, #8]
	.inst 0xc2c2a7a1 // chkeq c29, c2
	b.ne comparison_fail
	.inst 0xc24026c2 // ldr c2, [x22, #9]
...
.section data0, #alloc, #write
	.zero 96
	.byte 0x00, 0x00, 0x01, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 3984
.data
check_data0:
	.zero 2
...
.data
check_data3:
	.byte 0x00, 0x00, 0x00, 0x00, 0x02, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 16
.data
check_data4:
	.zero 32
...
initial_DDC_EL0_value:
	.octa 0x800000005202038f0000000000000000
initial_DDC_EL1_value:
	.octa 0xc0000000048700010000000000000181
