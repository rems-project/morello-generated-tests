...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2400680 // ldr c0, [x20, #1]
	.inst 0xc2c0a4a1 // chkeq c5, c0
	b.ne comparison_fail
	.inst 0xc2400a80 // ldr c0, [x20, #2]
	.inst 0xc2c0a581 // chkeq c12, c0
	b.ne comparison_fail
	.inst 0xc2400e80 // ldr c0, [x20, #3]
	.inst 0xc2c0a5c1 // chkeq c14, c0
	b.ne comparison_fail
	.inst 0xc2401280 // ldr c0, [x20, #4]
	.inst 0xc2c0a601 // chkeq c16, c0
	b.ne comparison_fail
	.inst 0xc2401680 // ldr c0, [x20, #5]
	.inst 0xc2c0a641 // chkeq c18, c0
	b.ne comparison_fail
	.inst 0xc2401a80 // ldr c0, [x20, #6]
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b280 // cvtp c0, x20
	.inst 0xc2d44000 // scvalue c0, c0, x20
	.inst 0x82600c14 // ldr x20, [c0, #0]
	cbnz x20, #28
	mrs x20, ESR_EL1
	.inst 0x82400c14 // str x20, [c0, #0]
	ldr x20, =0x40400028
	mrs x0, ELR_EL1
	sub x20, x20, x0
	cbnz x20, #8
