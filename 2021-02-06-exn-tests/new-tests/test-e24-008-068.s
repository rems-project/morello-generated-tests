...
initial_cap_values:
	...
	.octa 0x1000
	/* C30 */
	.octa 0xc0100000000100070000000000001580
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x1000
	/* C30 */
	.octa 0xc0100000000100070000000000001a20
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b303 // cvtp c3, x24
	.inst 0xc2d84063 // scvalue c3, c3, x24
	.inst 0x82600c78 // ldr x24, [c3, #0]
	cbnz x24, #28
	mrs x24, ESR_EL1
	.inst 0x82400c78 // str x24, [c3, #0]
	ldr x24, =0x40400028
	mrs x3, ELR_EL1
	sub x24, x24, x3
	cbnz x24, #8
