...
initial_cap_values:
	/* C0 */
	.octa 0xc0000000400205f1000000000000180c
	/* C15 */
	.octa 0x2040a0000000a008000000004040000d
	/* C19 */
	.octa 0x3f80000000000002
	/* C24 */
	.octa 0x402000000000000000000000000000
	/* C25 */
	.octa 0x1f7d
	/* C30 */
	.octa 0xc0000000600100050000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0xc00000003f8100070000000000000001
initial_DDC_EL1_value:
	.octa 0x80000000000700860000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080005000841e0000000040408801
final_PCC_value:
...
.section vector_table_el1, #alloc, #execinstr
	ldr x6, =esr_el1_dump_address
	.inst 0xc2c5b0ce // cvtp c14, x6
	.inst 0xc2c641ce // scvalue c14, c14, x6
	.inst 0x82600dc6 // ldr x6, [c14, #0]
	cbnz x6, #28
	mrs x6, ESR_EL1
	.inst 0x82400dc6 // str x6, [c14, #0]
	ldr x6, =0x40408c14
	mrs x14, ELR_EL1
	sub x6, x6, x14
	cbnz x6, #8
