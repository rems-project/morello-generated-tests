...
.section data0, #alloc, #write
	.zero 96
	.byte 0x00, 0x00, 0x1b, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 1936
	.byte 0x62, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 2032
.data
check_data0:
	.zero 2
...
.data
check_data4:
	.byte 0x00, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x00
.data
check_data5:
	.zero 2
.data
...
initial_DDC_EL0_value:
	.octa 0xcc1000000017000f0000000000000001
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_PCC_value:
	.octa 0x2000800003e300070000000040400028
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x2000800003e300070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b34c // cvtp c12, x26
	.inst 0xc2da418c // scvalue c12, c12, x26
	.inst 0x82600d9a // ldr x26, [c12, #0]
	cbnz x26, #28
	mrs x26, ESR_EL1
	.inst 0x82400d9a // str x26, [c12, #0]
	ldr x26, =0x40400028
	mrs x12, ELR_EL1
	sub x26, x26, x12
	cbnz x26, #8
