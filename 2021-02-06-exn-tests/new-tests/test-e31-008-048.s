...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402452 // ldr c18, [x2, #9]
	.inst 0xc2d2a7a1 // chkeq c29, c18
	b.ne comparison_fail
	.inst 0xc2402852 // ldr c18, [x2, #10]
...
.data
check_data2:
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x20, 0x00, 0x00, 0x10, 0x10, 0x08, 0x40, 0x80, 0x02
.data
check_data3:
...
initial_cap_values:
	...
	.octa 0x1008
	/* C10 */
	.octa 0x8000000050040079fe800140c317106e
	/* C12 */
	.octa 0x20000000900050000000000040400801
	/* C15 */
	.octa 0x2804008101000002000080000000000
	/* C21 */
	.octa 0x0
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0x800000005804010000ffffffffffe000
initial_DDC_EL1_value:
	.octa 0xd81000005f81000400ffffffffffe001
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x2000800038c300070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x2, =esr_el1_dump_address
	.inst 0xc2c5b052 // cvtp c18, x2
	.inst 0xc2c24252 // scvalue c18, c18, x2
	.inst 0x82600e42 // ldr x2, [c18, #0]
	cbnz x2, #28
	mrs x2, ESR_EL1
	.inst 0x82400e42 // str x2, [c18, #0]
	ldr x2, =0x40400414
	mrs x18, ELR_EL1
	sub x2, x2, x18
	cbnz x2, #8
