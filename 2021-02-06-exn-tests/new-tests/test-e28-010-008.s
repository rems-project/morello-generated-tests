...
tag_init_end:
	...
	ldr x17, =0x200
	msr CPTR_EL3, x17
	ldr x17, =initial_RSP_EL0_value
	.inst 0xc2400231 // ldr c17, [x17, #0]
	.inst 0xc28f4171 // msr RSP_EL0, c17
	ldr x17, =0x30d5d99f
	msr SCTLR_EL1, x17
	ldr x17, =0x3c0000
	msr CPACR_EL1, x17
...
initial_cap_values:
	...
	.octa 0xf55
	/* C18 */
	.octa 0x20000000800100050000000040400020
	/* C30 */
	.octa 0x1800
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0xc0000000540704870000000000000001
initial_DDC_EL1_value:
	.octa 0xc00000000000c0000000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080006000e40e0000000040400000
final_PCC_value:
	.octa 0x200080006000e40e0000000040400414
