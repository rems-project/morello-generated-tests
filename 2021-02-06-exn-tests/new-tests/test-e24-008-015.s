...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2401448 // ldr c8, [x2, #5]
	.inst 0xc2c8a721 // chkeq c25, c8
	b.ne comparison_fail
	.inst 0xc2401848 // ldr c8, [x2, #6]
	.inst 0xc2c8a7a1 // chkeq c29, c8
	b.ne comparison_fail
	.inst 0xc2401c48 // ldr c8, [x2, #7]
...
.section data0, #alloc, #write
	.zero 2048
	.byte 0x00, 0x00, 0x00, 0x00, 0xfd, 0x17, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 2032
.data
check_data0:
	.zero 16
...
initial_cap_values:
	/* C13 */
	.octa 0x400000005fba00320000000000002002
	/* C25 */
	.octa 0x17f6
	/* C29 */
	.octa 0x1002
...
final_cap_values:
	...
	.octa 0x0
	/* C1 */
	.octa 0x20008000000100070000000000001002
	/* C13 */
	.octa 0x400000005fba00320000000000002002
	/* C21 */
	.octa 0x0
...
initial_DDC_EL0_value:
	.octa 0xd00000006001080200ffffffffffe001
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b048 // cvtp c8, x2
	.inst 0xc2c24108 // scvalue c8, c8, x2
	.inst 0x82600d02 // ldr x2, [c8, #0]
	cbnz x2, #28
	mrs x2, ESR_EL1
	.inst 0x82400d02 // str x2, [c8, #0]
	ldr x2, =0x40400028
	mrs x8, ELR_EL1
	sub x2, x2, x8
	cbnz x2, #8
