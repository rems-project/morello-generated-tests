...
initial_cap_values:
	/* C3 */
	.octa 0x20008000c001c00d000000004040c010
	/* C10 */
	.octa 0x4041002c
	/* C17 */
	.octa 0x20008000000100050000000040400018
	/* C23 */
	.octa 0x8000400020032007e400000000000047
	/* C24 */
...
initial_DDC_EL0_value:
	.octa 0xd81000000006000700ffffffffe00000
...
.section vector_table_el1, #alloc, #execinstr
	ldr x1, =esr_el1_dump_address
	.inst 0xc2c5b026 // cvtp c6, x1
	.inst 0xc2c140c6 // scvalue c6, c6, x1
	.inst 0x82600cc1 // ldr x1, [c6, #0]
	cbnz x1, #28
	mrs x1, ESR_EL1
	.inst 0x82400cc1 // str x1, [c6, #0]
	ldr x1, =0x40400028
	mrs x6, ELR_EL1
	sub x1, x1, x6
	cbnz x1, #8
