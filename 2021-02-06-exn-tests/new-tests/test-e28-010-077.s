...
tag_init_end:
	...
	ldr x27, =initial_RSP_EL0_value
	.inst 0xc240037b // ldr c27, [x27, #0]
	.inst 0xc28f417b // msr RSP_EL0, c27
	ldr x27, =0x30d5d99f
	msr SCTLR_EL1, x27
	ldr x27, =0x3c0000
	msr CPACR_EL1, x27
...
.data
check_data1:
	.byte 0x01, 0x00, 0x00, 0x20, 0x08, 0x00, 0x00, 0x02
.data
check_data2:
	.zero 2
.data
...
initial_cap_values:
	...
	.octa 0x0
	/* C12 */
	.octa 0x200000820000001
	/* C14 */
	.octa 0x400000000021c0050000000000001005
	/* C18 */
	.octa 0x20000000c00103400000000040403781
	/* C30 */
	.octa 0xc0000000000704070000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_RSP_EL0_value:
	.octa 0x90000000000010
initial_DDC_EL0_value:
	.octa 0xc00000005a0a0a940000000000000001
initial_VBAR_EL1_value:
	.octa 0x20008000444000440000000040400001
final_PCC_value:
	.octa 0x20008000444000440000000040400414
