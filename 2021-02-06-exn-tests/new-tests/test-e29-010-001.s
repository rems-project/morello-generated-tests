...
.section data0, #alloc, #write
	.byte 0x82, 0xd1, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
	.byte 0x02, 0x2a, 0xff, 0xff
.data
check_data1:
	.zero 32
.data
...
initial_cap_values:
	...
	.octa 0x1000
	/* C17 */
	.octa 0x20008000800f80070000000040408000
	/* C24 */
	.octa 0x1040
	/* C26 */
	.octa 0x1000
...
initial_DDC_EL0_value:
	.octa 0xd0000000000700070000000000000001
initial_DDC_EL1_value:
	.octa 0x80000000000100050000000000000001
initial_VBAR_EL1_value:
	.octa 0x20008000600000410000000040400000
final_PCC_value:
	.octa 0x20008000000f8007000000004040800c
...
.section vector_table_el1, #alloc, #execinstr
	ldr x3, =esr_el1_dump_address
	.inst 0xc2c5b064 // cvtp c4, x3
	.inst 0xc2c34084 // scvalue c4, c4, x3
	.inst 0x82600c83 // ldr x3, [c4, #0]
	cbnz x3, #28
	mrs x3, ESR_EL1
	.inst 0x82400c83 // str x3, [c4, #0]
	ldr x3, =0x4040800c
	mrs x4, ELR_EL1
	sub x3, x3, x4
	cbnz x3, #8
