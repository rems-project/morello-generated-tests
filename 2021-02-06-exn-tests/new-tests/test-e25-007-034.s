...
tag_init_end:
	...
	ldr x9, =0x200
	msr CPTR_EL3, x9
	ldr x9, =initial_RSP_EL0_value
	.inst 0xc2400129 // ldr c9, [x9, #0]
	.inst 0xc28f4169 // msr RSP_EL0, c9
	ldr x9, =0x30d5d99f
	msr SCTLR_EL1, x9
	ldr x9, =0xc0000
	msr CPACR_EL1, x9
...
initial_cap_values:
	...
	.octa 0x0
	/* C5 */
	.octa 0xc0000000000300040000000000001000
	/* C6 */
	.octa 0x8010000000010005000000004040a4e0
	/* C8 */
	.octa 0x0
	/* C10 */
	.octa 0x4
	/* C12 */
	.octa 0x20000000c009004d0000000040400081
	/* C15 */
	.octa 0x1004
	/* C17 */
	.octa 0x800000000000000000000000404006c8
	/* C30 */
	.octa 0x1101
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x4
	/* C12 */
	.octa 0x2000800004064007190000004040000d
	/* C15 */
	.octa 0x1004
	/* C17 */
	.octa 0x8000000000000000000000004040076c
	/* C19 */
	.octa 0x0
	/* C30 */
	.octa 0x0
...
initial_DDC_EL0_value:
	.octa 0xc0000000000040000080239ffcf81400
initial_VBAR_EL1_value:
	.octa 0x8000400000000000000000000000
final_PCC_value:
	.octa 0x200000004009004d000000004040009c
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000040640070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
