...
initial_cap_values:
	/* C0 */
	.octa 0xc0000000000100050000000000001f8b
	/* C15 */
	.octa 0x20408002000100070000000040402005
	/* C19 */
	.octa 0x8f3dfe82ebfef801
	/* C24 */
	.octa 0x400002000000002000000000000000
	/* C25 */
	.octa 0x1000
	/* C30 */
	.octa 0xc00000004104040c0000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x1000
	/* C29 */
	.octa 0x400000000000002000000000000000
	/* C30 */
	.octa 0xc00000004104040c0000000000001000
initial_DDC_EL0_value:
	.octa 0xc0000000002200030080000000000000
initial_DDC_EL1_value:
	.octa 0x901000005f80008000ffffffffffe001
initial_VBAR_EL1_value:
	.octa 0x200080004800c01e000000004040c001
final_PCC_value:
	.octa 0x200080004800c01e000000004040c414
...
.section vector_table_el1, #alloc, #execinstr
	ldr x27, =esr_el1_dump_address
	.inst 0xc2c5b377 // cvtp c23, x27
	.inst 0xc2db42f7 // scvalue c23, c23, x27
	.inst 0x82600efb // ldr x27, [c23, #0]
	cbnz x27, #28
	mrs x27, ESR_EL1
	.inst 0x82400efb // str x27, [c23, #0]
	ldr x27, =0x4040c414
	mrs x23, ELR_EL1
	sub x27, x27, x23
	cbnz x27, #8
