...
initial_cap_values:
	...
	/* C30 */
	.octa 0xc0000000600000040000000000001000
el1_vector_jump_cap:
	.dword 0x40400300
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c040e7 // scvalue c7, c7, x0
	.inst 0x82600ce0 // ldr x0, [c7, #0]
	cbnz x0, #28
	mrs x0, ESR_EL1
	.inst 0x82400ce0 // str x0, [c7, #0]
	ldr x0, =0x40400028
	mrs x7, ELR_EL1
	sub x0, x0, x7
	cbnz x0, #8
