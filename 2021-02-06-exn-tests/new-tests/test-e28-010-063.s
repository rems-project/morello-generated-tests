...
.data
check_data0:
	.byte 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x02, 0x01
.data
check_data1:
	.zero 8
.data
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c0414a // scvalue c10, c10, x0
	.inst 0x82600d40 // ldr x0, [c10, #0]
	cbnz x0, #28
	mrs x0, ESR_EL1
	.inst 0x82400d40 // str x0, [c10, #0]
	ldr x0, =0x40400028
	mrs x10, ELR_EL1
	sub x0, x0, x10
	cbnz x0, #8
