...
initial_cap_values:
	...
	.octa 0x0
	/* C4 */
	.octa 0x2443c000000a40020000000000000000
	/* C5 */
	.octa 0xf30
	/* C12 */
	.octa 0x80000000520000000000000000000f0a
	/* C16 */
	.octa 0x1010
	/* C23 */
	.octa 0x0
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b31e // cvtp c30, x24
	.inst 0xc2d843de // scvalue c30, c30, x24
	.inst 0x82600fd8 // ldr x24, [c30, #0]
	cbnz x24, #28
	mrs x24, ESR_EL1
	.inst 0x82400fd8 // str x24, [c30, #0]
	ldr x24, =0x40400028
	mrs x30, ELR_EL1
	sub x24, x24, x30
	cbnz x24, #8
