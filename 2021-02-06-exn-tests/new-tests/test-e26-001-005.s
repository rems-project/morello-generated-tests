...
.section data0, #alloc, #write
	.zero 1440
	.byte 0x00, 0x00, 0x00, 0x00, 0xc9, 0x81, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 2640
.data
check_data0:
	.zero 2
...
final_cap_values:
	...
	.octa 0x0
	/* C1 */
	.octa 0xc0002000003ffffffffc8000
	/* C10 */
	.octa 0x1000
	/* C15 */
	.octa 0x0
...
initial_SP_EL0_value:
	.octa 0x800000002007a003ffa0029847ffff20
initial_SP_EL1_value:
	.octa 0xc0002000003ffffffffc0000
initial_DDC_EL0_value:
	.octa 0xc00000007104000000ffffffffffe001
initial_DDC_EL1_value:
	.octa 0xc0000000027d000400ffffff00000001
initial_VBAR_EL1_value:
	.octa 0x2000800048000c1d0000000040402000
final_SP_EL0_value:
	.octa 0x800000002007a003ffa0029847ffff20
final_SP_EL1_value:
	.octa 0xc0002000003ffffffffc0000
final_PCC_value:
	.octa 0x2000800048000c1d0000000040402414
...
.section vector_table_el1, #alloc, #execinstr
	ldr x11, =esr_el1_dump_address
	.inst 0xc2c5b165 // cvtp c5, x11
	.inst 0xc2cb40a5 // scvalue c5, c5, x11
	.inst 0x82600cab // ldr x11, [c5, #0]
	cbnz x11, #28
	mrs x11, ESR_EL1
	.inst 0x82400cab // str x11, [c5, #0]
	ldr x11, =0x40402414
	mrs x5, ELR_EL1
	sub x11, x11, x5
	cbnz x11, #8
