...
.section data0, #alloc, #write
	.zero 3024
	.byte 0x06, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 1056
.data
check_data0:
	.zero 2
...
initial_cap_values:
	/* C0 */
	.octa 0xc0000000000100050000000000001bd0
	/* C1 */
	.octa 0xc0
	/* C7 */
	.octa 0x0
	/* C8 */
	.octa 0x8000040008c000
	/* C10 */
	.octa 0x2023
	/* C11 */
	.octa 0x8001206600000003ffe85ff9
	/* C13 */
...
final_SP_EL0_value:
	.octa 0x80012066414000040008c000
final_PCC_value:
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b2d3 // cvtp c19, x22
	.inst 0xc2d64273 // scvalue c19, c19, x22
	.inst 0x82600e76 // ldr x22, [c19, #0]
	cbnz x22, #28
	mrs x22, ESR_EL1
	.inst 0x82400e76 // str x22, [c19, #0]
	ldr x22, =0x40400028
	mrs x19, ELR_EL1
	sub x22, x22, x19
	cbnz x22, #8
