...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402144 // ldr c4, [x10, #8]
	.inst 0xc2c4a701 // chkeq c24, c4
	b.ne comparison_fail
	.inst 0xc2402544 // ldr c4, [x10, #9]
	.inst 0xc2c4a741 // chkeq c26, c4
	b.ne comparison_fail
	.inst 0xc2402944 // ldr c4, [x10, #10]
	.inst 0xc2c4a7a1 // chkeq c29, c4
	b.ne comparison_fail
	.inst 0xc2402d44 // ldr c4, [x10, #11]
...
.section data0, #alloc, #write
	...
	.byte 0xd5, 0xeb, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4064
.data
check_data0:
	.byte 0x88, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
.data
check_data1:
	.byte 0xd5, 0xeb
.data
...
initial_cap_values:
	/* C0 */
	.octa 0x40000000000100050000000000000cb2
	/* C1 */
	.octa 0x0
	/* C3 */
	.octa 0x1fe0
	...
	.octa 0x0
	/* C30 */
	.octa 0x40000000002700270000000000000f88
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL1_value:
	.octa 0xd0100000400201c20000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080004800d01d0000000040400000
final_SP_EL0_value:
	.octa 0xc0000000000080080000000000001010
final_PCC_value:
