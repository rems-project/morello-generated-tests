...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2400c82 // ldr c2, [x4, #3]
	.inst 0xc2c2a681 // chkeq c20, c2
	b.ne comparison_fail
	.inst 0xc2401082 // ldr c2, [x4, #4]
	.inst 0xc2c2a6c1 // chkeq c22, c2
	b.ne comparison_fail
	.inst 0xc2401482 // ldr c2, [x4, #5]
	.inst 0xc2c2a701 // chkeq c24, c2
	b.ne comparison_fail
	.inst 0xc2401882 // ldr c2, [x4, #6]
...
.section data0, #alloc, #write
	.zero 32
	.byte 0x02, 0x00, 0x01, 0xc0, 0xff, 0xff, 0x7f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 4048
.data
check_data0:
	.zero 4
...
initial_cap_values:
	/* C0 */
	.octa 0xdc000000600000240000000000001020
	/* C5 */
	.octa 0x4000000070040081fffffffffffff0a0
	/* C13 */
	.octa 0x0
	/* C29 */
	.octa 0x40000000200700150000000000001080
	/* C30 */
	.octa 0x0
el1_vector_jump_cap:
	.dword 0x40400300
...
final_cap_values:
	...
	.octa 0x0
	/* C20 */
	.octa 0x20008000400000be00800000004100c0
	/* C22 */
	.octa 0x0
	/* C24 */
	.octa 0x0
...
initial_DDC_EL0_value:
	.octa 0x8000000020010005007fffffc0202001
initial_VBAR_EL1_value:
	.octa 0x20008000400000be0000000040400000
final_PCC_value:
	.octa 0x20008000400000be0000000040400414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000122300070000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x4, =esr_el1_dump_address
	.inst 0xc2c5b082 // cvtp c2, x4
	.inst 0xc2c44042 // scvalue c2, c2, x4
	.inst 0x82600c44 // ldr x4, [c2, #0]
	cbnz x4, #28
	mrs x4, ESR_EL1
	.inst 0x82400c44 // str x4, [c2, #0]
	ldr x4, =0x40400414
	mrs x2, ELR_EL1
	sub x4, x4, x2
	cbnz x4, #8
