...
initial_cap_values:
	...
	.octa 0x1f35
	/* C18 */
	.octa 0x20008000c00105050000000040402400
	/* C30 */
	.octa 0x1000
el1_vector_jump_cap:
	.dword 0x40400300
...
final_SP_EL0_value:
	.octa 0x90000000000100050000000000001000
final_PCC_value:
	.octa 0x20008000400105050000000040402418
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b077 // cvtp c23, x3
	.inst 0xc2c342f7 // scvalue c23, c23, x3
	.inst 0x82600ee3 // ldr x3, [c23, #0]
	cbnz x3, #28
	mrs x3, ESR_EL1
	.inst 0x82400ee3 // str x3, [c23, #0]
	ldr x3, =0x40402418
	mrs x23, ELR_EL1
	sub x3, x3, x23
	cbnz x3, #8
