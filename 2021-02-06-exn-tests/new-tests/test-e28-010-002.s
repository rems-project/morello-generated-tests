...
tag_init_end:
	...
	ldr x20, =0x200
	msr CPTR_EL3, x20
	ldr x20, =initial_RSP_EL0_value
	.inst 0xc2400294 // ldr c20, [x20, #0]
	.inst 0xc28f4174 // msr RSP_EL0, c20
	ldr x20, =0x30d5d99f
	msr SCTLR_EL1, x20
	ldr x20, =0x3c0000
	msr CPACR_EL1, x20
...
initial_cap_values:
	...
	.octa 0xf45
	/* C18 */
	.octa 0x20000000a00040800000000040400100
	/* C30 */
	.octa 0x1000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_VBAR_EL1_value:
	.octa 0x200080004000841c0000000040409000
final_PCC_value:
	.octa 0x200080004000841c0000000040409414
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000002180050000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x20, =esr_el1_dump_address
	.inst 0xc2c5b29b // cvtp c27, x20
	.inst 0xc2d4437b // scvalue c27, c27, x20
	.inst 0x82600f74 // ldr x20, [c27, #0]
	cbnz x20, #28
	mrs x20, ESR_EL1
	.inst 0x82400f74 // str x20, [c27, #0]
	ldr x20, =0x40409414
	mrs x27, ELR_EL1
	sub x20, x20, x27
	cbnz x20, #8
