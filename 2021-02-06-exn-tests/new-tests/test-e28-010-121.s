...
.data
check_data0:
	.byte 0x00, 0x00, 0x04, 0x02, 0x00, 0x00, 0x00, 0x00
.data
check_data1:
	.zero 2
.data
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b33d // cvtp c29, x25
	.inst 0xc2d943bd // scvalue c29, c29, x25
	.inst 0x82600fb9 // ldr x25, [c29, #0]
	cbnz x25, #28
	mrs x25, ESR_EL1
	.inst 0x82400fb9 // str x25, [c29, #0]
	ldr x25, =0x40400028
	mrs x29, ELR_EL1
	sub x25, x25, x29
	cbnz x25, #8
