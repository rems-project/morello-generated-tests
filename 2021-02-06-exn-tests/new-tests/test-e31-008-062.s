...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2400d62 // ldr c2, [x11, #3]
	.inst 0xc2c2a481 // chkeq c4, c2
	b.ne comparison_fail
	.inst 0xc2401162 // ldr c2, [x11, #4]
	.inst 0xc2c2a4e1 // chkeq c7, c2
	b.ne comparison_fail
	.inst 0xc2401562 // ldr c2, [x11, #5]
	.inst 0xc2c2a541 // chkeq c10, c2
	b.ne comparison_fail
	.inst 0xc2401962 // ldr c2, [x11, #6]
	.inst 0xc2c2a581 // chkeq c12, c2
	b.ne comparison_fail
	.inst 0xc2401d62 // ldr c2, [x11, #7]
	.inst 0xc2c2a5e1 // chkeq c15, c2
	b.ne comparison_fail
	.inst 0xc2402162 // ldr c2, [x11, #8]
	.inst 0xc2c2a6a1 // chkeq c21, c2
	b.ne comparison_fail
	.inst 0xc2402562 // ldr c2, [x11, #9]
	.inst 0xc2c2a7a1 // chkeq c29, c2
	b.ne comparison_fail
	.inst 0xc2402962 // ldr c2, [x11, #10]
...
.data
check_data1:
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x40, 0x01, 0x20
.data
check_data2:
	.zero 4
.data
...
initial_cap_values:
	...
	.octa 0x1ff8
	/* C10 */
	.octa 0x80000000000100050000080000000001
	/* C12 */
	.octa 0x20000000800100050000000040400011
	/* C15 */
	.octa 0x20014000000000000000000000000000
	/* C21 */
	.octa 0x0
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL1_value:
	.octa 0xd80000005f8100040000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080007000a41c000000004040a800
final_SP_EL1_value:
	.octa 0x2000
final_PCC_value:
	.octa 0x200080007000a41c000000004040ac14
...
.section vector_table_el1, #alloc, #execinstr
	ldr x11, =esr_el1_dump_address
	.inst 0xc2c5b162 // cvtp c2, x11
	.inst 0xc2cb4042 // scvalue c2, c2, x11
	.inst 0x82600c4b // ldr x11, [c2, #0]
	cbnz x11, #28
	mrs x11, ESR_EL1
	.inst 0x82400c4b // str x11, [c2, #0]
	ldr x11, =0x4040ac14
	mrs x2, ELR_EL1
	sub x11, x11, x2
	cbnz x11, #8
