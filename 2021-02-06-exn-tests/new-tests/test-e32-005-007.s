...
finish:
	...
	b.ne comparison_fail
	.inst 0xc2402698 // ldr c24, [x20, #9]
	.inst 0xc2d8a6e1 // chkeq c23, c24
	b.ne comparison_fail
	.inst 0xc2402a98 // ldr c24, [x20, #10]
	.inst 0xc2d8a761 // chkeq c27, c24
	b.ne comparison_fail
	.inst 0xc2402e98 // ldr c24, [x20, #11]
	.inst 0xc2d8a7a1 // chkeq c29, c24
	b.ne comparison_fail
	.inst 0xc2403298 // ldr c24, [x20, #12]
...
initial_cap_values:
	/* C3 */
	.octa 0x800000005c000c110000000000001810
	/* C4 */
	.octa 0x1000
	/* C7 */
	.octa 0x80100000000700470000000000001000
	/* C11 */
	.octa 0x4000000000000000000000000000
	/* C16 */
	.octa 0x1100
	/* C21 */
	.octa 0xc000000040009005ffd077ba345c9ff9
	/* C23 */
	.octa 0x0
	/* C27 */
	.octa 0x1000
...
final_cap_values:
	...
	.octa 0x1000
	/* C3 */
	.octa 0x800000005c000c1100000000000018e5
	/* C4 */
	.octa 0x1000
	/* C7 */
	.octa 0x80100000000700470000000000001000
...
initial_DDC_EL1_value:
	.octa 0xd80000000187010f00ffffffffffe001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x20, =esr_el1_dump_address
	.inst 0xc2c5b298 // cvtp c24, x20
	.inst 0xc2d44318 // scvalue c24, c24, x20
	.inst 0x82600f14 // ldr x20, [c24, #0]
	cbnz x20, #28
	mrs x20, ESR_EL1
	.inst 0x82400f14 // str x20, [c24, #0]
	ldr x20, =0x40403414
	mrs x24, ELR_EL1
	sub x20, x20, x24
	cbnz x20, #8
