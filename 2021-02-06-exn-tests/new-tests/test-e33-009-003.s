...
initial_cap_values:
	/* C0 */
	.octa 0xc000000000060002000000000000120b
	/* C15 */
...
initial_DDC_EL1_value:
	.octa 0x90000000000600070000000000000001
initial_VBAR_EL1_value:
	.octa 0x200080005600861d0000000040409001
final_PCC_value:
	.octa 0x200080005600861d0000000040409414
...
.section vector_table_el1, #alloc, #execinstr
	ldr x26, =esr_el1_dump_address
	.inst 0xc2c5b34a // cvtp c10, x26
	.inst 0xc2da414a // scvalue c10, c10, x26
	.inst 0x82600d5a // ldr x26, [c10, #0]
	cbnz x26, #28
	mrs x26, ESR_EL1
	.inst 0x82400d5a // str x26, [c10, #0]
	ldr x26, =0x40409414
	mrs x10, ELR_EL1
	sub x26, x26, x10
	cbnz x26, #8
