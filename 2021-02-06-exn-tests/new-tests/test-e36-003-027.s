...
tag_init_end:
	...
	.inst 0xc24013d1 // ldr c17, [x30, #4]
	.inst 0xc24017d7 // ldr c23, [x30, #5]
	.inst 0xc2401bdb // ldr c27, [x30, #6]
	.inst 0xc2401fdc // ldr c28, [x30, #7]
	...
	ldr x30, =initial_SP_EL1_value
	.inst 0xc24003de // ldr c30, [x30, #0]
	.inst 0xc28c411e // msr CSP_EL1, c30
	ldr x30, =0x200
	msr CPTR_EL3, x30
	ldr x30, =0x30d5d99f
	msr SCTLR_EL1, x30
...
.section vector_table_el1, #alloc, #execinstr
	ldr x30, =esr_el1_dump_address
	.inst 0xc2c5b3d8 // cvtp c24, x30
	.inst 0xc2de4318 // scvalue c24, c24, x30
	.inst 0x82600f1e // ldr x30, [c24, #0]
	cbnz x30, #28
	mrs x30, ESR_EL1
	.inst 0x82400f1e // str x30, [c24, #0]
	ldr x30, =0x40401414
	mrs x24, ELR_EL1
	sub x30, x30, x24
	cbnz x30, #8
