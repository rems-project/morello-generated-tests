...
initial_cap_values:
	/* C3 */
	.octa 0x20008000800000000000000040400011
	/* C10 */
	.octa 0x80000000400100020000000040400100
	/* C17 */
	.octa 0x20008000000100050000000040408001
	/* C23 */
	.octa 0x4000000000003f001800000000c4
	/* C24 */
...
final_cap_values:
	...
	/* C13 */
	.octa 0x2000800000010005ffffffffe18aa000
	/* C15 */
...
initial_VBAR_EL1_value:
	.octa 0x200080004000c408000000004040d000
final_PCC_value:
	.octa 0x20008000000100050000000040408010
pcc_return_ddc_capabilities:
	.dword pcc_return_ddc_capabilities
	.dword 0xFFFFC00000010005
	.octa 0x20008000500500000000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x9, =esr_el1_dump_address
	.inst 0xc2c5b134 // cvtp c20, x9
	.inst 0xc2c94294 // scvalue c20, c20, x9
	.inst 0x82600e89 // ldr x9, [c20, #0]
	cbnz x9, #28
	mrs x9, ESR_EL1
	.inst 0x82400e89 // str x9, [c20, #0]
	ldr x9, =0x40408010
	mrs x20, ELR_EL1
	sub x9, x9, x20
	cbnz x9, #8
