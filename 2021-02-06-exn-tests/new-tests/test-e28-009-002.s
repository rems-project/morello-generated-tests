...
.section data0, #alloc, #write
	...
	.zero 3088
	.byte 0x00, 0x20, 0x40, 0x40, 0x00, 0x00, 0x00, 0x00, 0x05, 0x00, 0x01, 0x80, 0x00, 0x80, 0x00, 0x20
	.zero 928
	.byte 0x03, 0x0c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
	.zero 32
.data
check_data0:
...
initial_cap_values:
	...
	.octa 0x1000
	/* C1 */
	.octa 0x7fffffffffffe1
	/* C4 */
	.octa 0x0
	/* C5 */
	.octa 0x90100000600000020000000000002000
	/* C23 */
	.octa 0x40000000042700070000000000000000
	/* C29 */
	.octa 0x20044c900010002000000800000
el1_vector_jump_cap:
	.dword 0x40400300
...
initial_DDC_EL0_value:
	.octa 0xc00000005080000100ffffffffffe000
initial_DDC_EL1_value:
	.octa 0x800000005fe4102d00ffffffffffe001
...
.section vector_table_el1, #alloc, #execinstr
	ldr x13, =esr_el1_dump_address
	.inst 0xc2c5b1a8 // cvtp c8, x13
	.inst 0xc2cd4108 // scvalue c8, c8, x13
	.inst 0x82600d0d // ldr x13, [c8, #0]
	cbnz x13, #28
	mrs x13, ESR_EL1
	.inst 0x82400d0d // str x13, [c8, #0]
	ldr x13, =0x40400414
	mrs x8, ELR_EL1
	sub x13, x13, x8
	cbnz x13, #8
