...
.data
check_data0:
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x02, 0x00, 0x00, 0x00, 0x00
.data
check_data1:
	.zero 2
.data
...
initial_cap_values:
	...
	/* C6 */
	.octa 0x800000005000d7b200000000403fac70
	/* C8 */
	.octa 0x0
	/* C10 */
	.octa 0x2020000
	/* C12 */
	.octa 0x20000000800780000000000040400100
	/* C15 */
	.octa 0x111c
	/* C17 */
...
final_cap_values:
	...
	.octa 0x2020000
	/* C12 */
	.octa 0x200080005000e00c190000004040000d
	/* C15 */
	.octa 0x111c
	/* C17 */
	.octa 0xffffffffffffff5c
...
initial_DDC_EL0_value:
	.octa 0xc0000000000300050000000000000001
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x200080005000e00c0000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
...
.section vector_table_el1, #alloc, #execinstr
	ldr x24, =esr_el1_dump_address
	.inst 0xc2c5b312 // cvtp c18, x24
	.inst 0xc2d84252 // scvalue c18, c18, x24
	.inst 0x82600e58 // ldr x24, [c18, #0]
	cbnz x24, #28
	mrs x24, ESR_EL1
	.inst 0x82400e58 // str x24, [c18, #0]
	ldr x24, =0x40400414
	mrs x18, ELR_EL1
	sub x24, x24, x18
	cbnz x24, #8
