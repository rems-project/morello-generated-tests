...
.section data0, #alloc, #write
	.byte 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xfd, 0xff, 0x40, 0xc0, 0x00, 0x00, 0x00, 0x00
	.zero 4080
.data
check_data0:
...
initial_cap_values:
	/* C13 */
	.octa 0x4000000040010fb80000000000002002
	/* C25 */
	.octa 0x4040fffc
	/* C29 */
	.octa 0x1008
...
final_cap_values:
	...
	.octa 0x0
	/* C1 */
	.octa 0x20008000000100070000000000001008
	/* C13 */
	.octa 0x4000000040010fb80000000000002002
	/* C21 */
	.octa 0x0
...
initial_DDC_EL0_value:
	.octa 0xd0000000000300060000000000000000
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b2ca // cvtp c10, x22
	.inst 0xc2d6414a // scvalue c10, c10, x22
	.inst 0x82600d56 // ldr x22, [c10, #0]
	cbnz x22, #28
	mrs x22, ESR_EL1
	.inst 0x82400d56 // str x22, [c10, #0]
	ldr x22, =0x40400028
	mrs x10, ELR_EL1
	sub x22, x22, x10
	cbnz x22, #8
