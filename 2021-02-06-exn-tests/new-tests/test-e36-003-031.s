...
finish:
	...
	b.ne comparison_fail
	.inst 0xc24026a9 // ldr c9, [x21, #9]
	.inst 0xc2c9a781 // chkeq c28, c9
	b.ne comparison_fail
	.inst 0xc2402aa9 // ldr c9, [x21, #10]
...
initial_SP_EL0_value:
	.octa 0x40000000400000010000000000002090
initial_SP_EL1_value:
	.octa 0xffffffffffffdb50
initial_DDC_EL0_value:
	.octa 0x8000000000098006000000000000e001
initial_DDC_EL1_value:
	.octa 0xc00000005100000000ffffffffffe001
...
pcc_return_ddc_capabilities:
	...
	.dword 0xFFFFC00000010005
	.octa 0x2000800031fb00030000000040400000
	.dword finish
	.dword 0xFFFFC00000010005
.balign 8
