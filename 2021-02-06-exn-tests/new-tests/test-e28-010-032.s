...
tag_init_end:
	...
	ldr x28, =initial_RSP_EL0_value
	.inst 0xc240039c // ldr c28, [x28, #0]
	.inst 0xc28f417c // msr RSP_EL0, c28
	ldr x28, =0x30d5d99f
	msr SCTLR_EL1, x28
	ldr x28, =0x3c0000
	msr CPACR_EL1, x28
...
.data
check_data0:
	.byte 0x00, 0x00, 0x00, 0x00, 0x40, 0x00, 0x02, 0x20
.data
check_data1:
	.zero 2
.data
...
initial_RSP_EL0_value:
	.octa 0x8010000000010005000000004040ffe0
...
.section vector_table_el1, #alloc, #execinstr
	...
	.inst 0xc2c5b39d // cvtp c29, x28
	.inst 0xc2dc43bd // scvalue c29, c29, x28
	.inst 0x82600fbc // ldr x28, [c29, #0]
	cbnz x28, #28
	mrs x28, ESR_EL1
	.inst 0x82400fbc // str x28, [c29, #0]
	ldr x28, =0x40400028
	mrs x29, ELR_EL1
	sub x28, x28, x29
	cbnz x28, #8
